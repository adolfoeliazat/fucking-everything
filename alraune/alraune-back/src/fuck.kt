...
fun emitCommandsForRenderingOrderParamsForm(commands: MutableList<AlBackToFrontCommandPile>, fields: OrderParamsFields) {
...
fun emitCommandsForRenderingOrderParamsPage(commands: MutableList<AlBackToFrontCommandPile>, fields: OrderParamsFields) {
    commands += AlBackToFrontCommandPile()-{o->
        val initCommands = mutableListOf<AlBackToFrontCommandPile>()
        val inputControlUUIDs = mutableListOf<String>()
