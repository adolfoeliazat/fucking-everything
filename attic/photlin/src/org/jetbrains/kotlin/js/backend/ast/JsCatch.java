...
public class JsCatch extends SourceInfoAwareJsNode implements HasCondition {
    ...
    public JsExpression typeExpression;
    ...
    public void traverse(JsVisitorWithContext v, JsContext ctx) {
        if (v.visit(this, ctx)) {
            ...
            if (typeExpression != null) {
                typeExpression = v.accept(typeExpression);
            }
    ...
    public JsCatch deepCopy() {
        ...
        JsCatch res = new JsCatch(scopeCopy, bodyCopy, conditionCopy, paramCopy);
        res.typeExpression = AstUtil.deepCopy(typeExpression);
        return res.withMetadataFrom(this);
    }
