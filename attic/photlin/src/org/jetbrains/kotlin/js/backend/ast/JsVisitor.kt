...
//    open fun visitPHPVarRef(varRef: PHPVarRef): Unit = visitElement(varRef)
    open fun visitPHPGlobalVarRef(varRef: PHPGlobalVarRef): Unit = visitElement(varRef)
...
//    open fun visit(x: PHPVar): Unit =
//        visitElement(x)

    open fun visitVars(x: JsVars): Unit =
        visitElement(x)

//    open fun visitPHPVars(x: PHPVars): Unit =
//            visitElement(x)
    ...
    open fun visitSingleLineComment(x: JsSingleLineComment): Unit = visitElement(x)
//    open fun visitPHPInvocation(x: PHPInvocation) = visitElement(x)
    open fun visitPHPMethodCall(x: PHPMethodCall) = visitElement(x)
    open fun visitPHPStaticMethodCall(x: PHPStaticMethodCall) = visitElement(x)
    open fun visitPHPClass(x: PHPClass) = visitElement(x)
    open fun visitPHPPlainCodeExpression(x: PHPPlainCodeExpression) = visitElement(x)
//    open fun visitPHPFieldRef(x: PHPFieldRef) = visitElement(x)
}
