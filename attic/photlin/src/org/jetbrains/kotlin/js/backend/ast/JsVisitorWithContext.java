...
//    public boolean visit(@NotNull PHPInvocation x, @NotNull JsContext ctx) {return true;}
//    public void endVisit(@NotNull PHPInvocation x, @NotNull JsContext ctx) {}

    public boolean visit(@NotNull PHPMethodCall x, @NotNull JsContext ctx) {return true;}
    public void endVisit(@NotNull PHPMethodCall x, @NotNull JsContext ctx) {}

//    public boolean visit(@NotNull PHPVarRef x, @NotNull JsContext ctx) {return true;}
//    public void endVisit(@NotNull PHPVarRef x, @NotNull JsContext ctx) {}

//    public boolean visit(@NotNull PHPVar x, @NotNull JsContext ctx) {return true;}
//    public void endVisit(@NotNull PHPVar x, @NotNull JsContext ctx) {}
//
//    public boolean visit(@NotNull PHPVars x, @NotNull JsContext ctx) {return true;}
//    public void endVisit(@NotNull PHPVars x, @NotNull JsContext ctx) {}

    public boolean visit(@NotNull PHPStaticMethodCall x, @NotNull JsContext ctx) {return true;}
    public void endVisit(@NotNull PHPStaticMethodCall x, @NotNull JsContext ctx) {}

    public boolean visit(@NotNull PHPClass x, @NotNull JsContext ctx) {return true;}
    public void endVisit(@NotNull PHPClass x, @NotNull JsContext ctx) {}

//    public boolean visit(@NotNull PHPFieldRef x, @NotNull JsContext ctx) {return true;}
//    public void endVisit(@NotNull PHPFieldRef x, @NotNull JsContext ctx) {}

    public boolean visit(@NotNull PHPGlobalVarRef x, @NotNull JsContext ctx) {return true;}
    public void endVisit(@NotNull PHPGlobalVarRef x, @NotNull JsContext ctx) {}
}
