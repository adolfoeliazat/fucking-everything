...
fun TranslationContext.translateAndAliasParameters(
    ...
    if (descriptor.requiresExtensionReceiverParameter) {
        ...
        aliases[descriptor.extensionReceiverParameter!!] = receiverParameterName.makePHPVarRef()
        targetList += JsParameter(receiverParameterName)-{o->
            o.kotlinType = descriptor.extensionReceiverParameter?.type
        }
    }

    for (valueParameter in descriptor.valueParameters) {
        targetList += JsParameter(getNameForDescriptor(valueParameter)).apply {
            hasDefaultValue = valueParameter.hasDefaultValue()
            this.valueDescriptor = valueParameter
        }
    }
