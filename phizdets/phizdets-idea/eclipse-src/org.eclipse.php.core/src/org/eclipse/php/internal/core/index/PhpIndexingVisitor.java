...
public class PhpIndexingVisitor extends PhpIndexingVisitorExtension {
	...
	public boolean visit(MethodDeclaration method) throws Exception {
		...
		Object shit = fCurrentQualifier != null ? fCurrentQualifierCounts.get(fCurrentQualifier) : 1;
		metadata.append(shit);
	...
	public boolean visit(TypeDeclaration type) throws Exception {
		if (type instanceof NamespaceDeclaration) {
			...
			StringBuilder metadata = new StringBuilder();
			Object obj = fCurrentQualifier != null ? fCurrentQualifierCounts.get(fCurrentQualifier) : 1;
			metadata.append(obj);
