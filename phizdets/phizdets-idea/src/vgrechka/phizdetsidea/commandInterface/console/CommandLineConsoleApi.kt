...
import vgrechka.phizdetsidea.commandInterface.command.CommandExecutor
import vgrechka.phizdetsidea.toolWindowWithActions.WindowWithActions
...
/**
 * Counterpart of jb_escape_output function on phizdets side. Messages with this prefix are considered to be escape sequence by [jbFilter]
 */
