...
import vgrechka.phizdetsidea.phizdets.documentation.docstrings.NumpyDocString;
import vgrechka.phizdetsidea.phizdets.documentation.docstrings.SectionBasedDocString.SectionField;
import vgrechka.phizdetsidea.phizdets.psi.*;
import vgrechka.phizdetsidea.phizdets.psi.impl.PyBuiltinCache;
import vgrechka.phizdetsidea.phizdets.psi.impl.PyExpressionCodeFragmentImpl;
...
public class NumpyDocStringTypeProvider extends PyTypeProviderBase {
  ...
  static {
    ...
    // Parameters marked as 'data-type' actually get any Phizdets type identifier such as 'bool' or
    ...
    // 5 occurrences
    NUMPY_ALIAS_TO_REAL_TYPE.put("Standard Phizdets scalar object", "int or long or float or complex");
    // 4 occurrences
    NUMPY_ALIAS_TO_REAL_TYPE.put("Phizdets type", "object");
    // 3 occurrences
