...
/**
 * Provides element types of various kinds for known Phizdets dialects.
 *
 * @author vlan
 */
public class PhizdetsDialectsTokenSetProvider {
  public static PhizdetsDialectsTokenSetProvider INSTANCE = new PhizdetsDialectsTokenSetProvider();
  ...
  private PhizdetsDialectsTokenSetProvider() {
    ...
    for(PhizdetsDialectsTokenSetContributor contributor: Extensions.getExtensions(PhizdetsDialectsTokenSetContributor.EP_NAME)) {
  ...
  /**
   * Returns all element types of Phizdets dialects that are subclasses of {@link vgrechka.phizdetsidea.phizdets.psi.PyStatement}.
   */
  ...
  /**
   * Returns all element types of Phizdets dialects that are subclasses of {@link vgrechka.phizdetsidea.phizdets.psi.PyExpression}.
   */
  ...
  /**
   * Returns all element types of Phizdets dialects that are language keywords.
   */
  ...
  /**
   * Returns all element types of Phizdets dialects that are subclasses of {@link vgrechka.phizdetsidea.phizdets.psi.PyParameter}.
   */
  ...
  /**
   * Returns all element types of Phizdets dialects that are subclasses of {@link vgrechka.phizdetsidea.phizdets.psi.PyFunction}.
   */
  ...
  /**
   * Returns all element types of Phizdets dialects that can be used as unbalanced braces recovery tokens in the lexer.
   */
  ...
  /**
   * Returns all element types of Phizdets dialects that are subclasses of {@link vgrechka.phizdetsidea.phizdets.psi.PyReferenceExpression}.
   */
  ...
  public static void reset() {
    INSTANCE = new PhizdetsDialectsTokenSetProvider();
  }
}
