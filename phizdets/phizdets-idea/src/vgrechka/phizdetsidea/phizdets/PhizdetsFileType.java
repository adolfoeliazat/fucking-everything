...
import icons.PhizdetsPsiApiIcons;
 ...
 * @author yole
 */
public class PhizdetsFileType extends LanguageFileType {
  ...
  public static PhizdetsFileType INSTANCE = new PhizdetsFileType();

  public PhizdetsFileType() {
    this(PhizdetsLanguage.INSTANCE);
  }

  public PhizdetsFileType(Language language) {
    super(language);
  }
  ...
  @NotNull
  public Icon getIcon() {
    return PhizdetsPsiApiIcons.PhizdetsFile;
  }
