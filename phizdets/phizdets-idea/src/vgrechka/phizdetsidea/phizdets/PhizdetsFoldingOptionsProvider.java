...
public class PhizdetsFoldingOptionsProvider extends BeanConfigurable<PhizdetsFoldingSettings> implements CodeFoldingOptionsProvider {
  protected PhizdetsFoldingOptionsProvider(PhizdetsFoldingSettings settings) {
    super(settings);
