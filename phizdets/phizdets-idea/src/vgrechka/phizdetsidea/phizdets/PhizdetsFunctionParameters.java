...
/**
 * Phizdets function arguments
 *
 * @author Ilya.Kazakevich
 */
public enum PhizdetsFunctionParameters implements FunctionParameter {
  /**
  ...
  PhizdetsFunctionParameters(@Nullable String name, final int position) {
    myName = name;
    myPosition = position;
  }
