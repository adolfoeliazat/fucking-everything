...
public class PhizdetsHelpersLocator {
  private static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.PhizdetsHelpersLocator");
  private static final String COMMUNITY_SUFFIX = "-community";

  private PhizdetsHelpersLocator() {}
  ...
  public static File getHelpersRoot() {
    @NonNls String jarPath = PathUtil.getJarPathForClass(PhizdetsHelpersLocator.class);
    ...
    return new File("E:\\work\\vendor\\jetbrains\\intellij-community-idea-171.4073.35\\python\\helpers");
//    return new File(jarPath + "-helpers");
  ...
  public static String getPhizdetsCommunityPath() {
