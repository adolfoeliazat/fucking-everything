 ...
 * @author yole
 */
public class PhizdetsSourceRootConfigurator implements DirectoryProjectConfigurator {
  ...
  public void configureProject(Project project, @NotNull VirtualFile baseDir, Ref<Module> moduleRef) {
    ...
    if (setupPy != null) {
      ...
      PyFile setupPyFile = (PyFile) PsiFileFactory.getInstance(project).createFileFromText(SETUP_PY, PhizdetsFileType.INSTANCE, content.toString());
