...
import vgrechka.phizdetsidea.phizdets.configuration.PyConfigureInterpretersLinkPanel;
import vgrechka.phizdetsidea.phizdets.run.AbstractPyCommonOptionsForm;
import vgrechka.phizdetsidea.phizdets.run.PyCommonOptionsFormData;
...
public class PyIdeCommonOptionsForm implements AbstractPyCommonOptionsForm {
  ...
  private JBLabel myPhizdetsInterpreterJBLabel;
  ...
  private List<Sdk> myPhizdetsSdks;
  ...
  public PyIdeCommonOptionsForm(PyCommonOptionsFormData data) {
    ...
    myPhizdetsSdks = new ArrayList<>(PhizdetsSdkType.getAllSdks());
    myPhizdetsSdks.add(0, null);

    myInterpreterComboBox.setModel(new CollectionComboBoxModel(myPhizdetsSdks, null));
  ...
  public void setAnchor(JComponent anchor) {
    ...
    myPhizdetsInterpreterJBLabel.setAnchor(anchor);
  }
  ...
  public void updateSdkList(boolean preserveSelection, PyConfigurableInterpreterList myInterpreterList) {
    myPhizdetsSdks = myInterpreterList.getAllPhizdetsSdks(myProject);
    Sdk selection = preserveSelection ? (Sdk)myInterpreterComboBox.getSelectedItem() : null;
    if (!myPhizdetsSdks.contains(selection)) {
      selection = null;
    }
    myPhizdetsSdks.add(0, null);
    myInterpreterComboBox.setModel(new CollectionComboBoxModel(myPhizdetsSdks, selection));
  }
  ...
  public void setUseModuleSdk(boolean useModuleSdk) {
    myInterpreterComboBox.setSelectedItem(useModuleSdk ? null : PhizdetsSdkType.findSdkByPath(myPhizdetsSdks, mySelectedSdkHome));
  }
