    ...
    messageBus.connect().subscribe(ProjectTopics.MODULES, new ModuleListener() {
      ...
      public void beforeModuleRemoved(@NotNull Project project, @NotNull Module module) {
        ...
        for (RunnerAndConfigurationSettings configuration : configurations) {
          if (configuration.getConfiguration() instanceof AbstractPhizdetsRunConfiguration) {
            final Module configModule = ((AbstractPhizdetsRunConfiguration)configuration.getConfiguration()).getModule();
