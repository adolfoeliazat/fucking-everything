...
public class BuildoutFacetType extends FacetType<BuildoutFacet, BuildoutFacetConfiguration> {
  private BuildoutFacetType() {
    super(ID, "buildout-phizdets", "Buildout Support", null);
  }
  ...
  public boolean isSuitableModuleType(ModuleType moduleType) {
    return moduleType instanceof PhizdetsModuleTypeBase;
  }

  public static final FacetTypeId<BuildoutFacet> ID = new FacetTypeId<>("buildout-phizdets");
  ...
  @Override
  public Icon getIcon() {
    return PhizdetsIcons.Phizdets.Buildout.Buildout;
  }
}
