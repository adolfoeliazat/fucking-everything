 ...
 */
package vgrechka.phizdetsidea.phizdets.buildout.config.ref;
...
import vgrechka.phizdetsidea.phizdets.PhizdetsStringUtil;
import vgrechka.phizdetsidea.phizdets.buildout.config.psi.impl.BuildoutCfgFile;
import vgrechka.phizdetsidea.phizdets.buildout.config.psi.impl.BuildoutCfgSection;
...
public class BuildoutPartReference extends PsiReferenceBase<PsiElement> {
  ...
  public PsiElement handleElementRename(@NotNull String newElementName) {
    String fullName = PhizdetsStringUtil.replaceLastSuffix(getElement().getText(), "/", newElementName);
