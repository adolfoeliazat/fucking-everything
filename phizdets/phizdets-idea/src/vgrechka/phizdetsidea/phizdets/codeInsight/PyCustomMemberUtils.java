...
/**
 * TODO: Move methods to {@link vgrechka.phizdetsidea.phizdets.codeInsight.PyCustomMember}. Only dependency hell prevents me from doing it
 */
public final class PyCustomMemberUtils {
  ...
  /**
   * Creates {@link com.intellij.codeInsight.lookup.LookupElement} to be used in cases like {@link vgrechka.phizdetsidea.phizdets.psi.types.PyType#getCompletionVariants(String, com.intellij.psi.PsiElement, com.intellij.util.ProcessingContext)}
   * This method should be in {@link vgrechka.phizdetsidea.phizdets.codeInsight.PyCustomMember} but it does not. We need to move it.
   *
