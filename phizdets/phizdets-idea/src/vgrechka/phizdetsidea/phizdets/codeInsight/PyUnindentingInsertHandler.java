...
import vgrechka.phizdetsidea.phizdets.codeInsight.completion.PhizdetsLookupElement;
 ...
 */
public class PyUnindentingInsertHandler implements InsertHandler<PhizdetsLookupElement> {
  public final static PyUnindentingInsertHandler INSTANCE = new PyUnindentingInsertHandler();

  private PyUnindentingInsertHandler() {
  }

  public void handleInsert(InsertionContext context, PhizdetsLookupElement item) {
