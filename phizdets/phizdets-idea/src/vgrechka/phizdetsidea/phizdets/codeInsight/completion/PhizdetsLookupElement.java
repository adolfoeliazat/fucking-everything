 ...
 */
public class PhizdetsLookupElement extends LookupElement implements Comparable<LookupElement>{
  ...
  protected InsertHandler<PhizdetsLookupElement> myHandler;

  public PhizdetsLookupElement(@NotNull final String lookupString,
                           @Nullable final String tailText,
                           @Nullable final String typeText, final boolean bold,
                           @Nullable final Icon icon,
                           @Nullable final Icon typeIcon,
                           @NotNull final InsertHandler<PhizdetsLookupElement> handler) {
  ...
  public void setHandler(InsertHandler<PhizdetsLookupElement> handler) {
    myHandler = handler;
  }
