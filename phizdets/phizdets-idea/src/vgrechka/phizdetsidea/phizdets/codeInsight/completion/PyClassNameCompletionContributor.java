...
public class PyClassNameCompletionContributor extends CompletionContributor {
  ...
  private static void addVariantsFromModules(CompletionResultSet result, PsiFile targetFile, boolean inStringLiteral) {
    Collection<VirtualFile> files = FileTypeIndex.getFiles(PhizdetsFileType.INSTANCE, PyProjectScopeBuilder.excludeSdkTestsScope(targetFile));
    for (VirtualFile file : files) {
      ...
      if (PhizdetsImportUtils.isImportableModule(targetFile, importable)) {
