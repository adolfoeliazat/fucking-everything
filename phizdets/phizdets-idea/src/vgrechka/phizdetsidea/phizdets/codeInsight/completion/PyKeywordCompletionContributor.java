...
import vgrechka.phizdetsidea.phizdets.codeInsight.PyUnindentingInsertHandler;
...
import vgrechka.phizdetsidea.phizdets.documentation.doctest.PyDocstringFile;
...
/**
 * Phizdets keyword completion contributor.
 * <br/>
...
public class PyKeywordCompletionContributor extends CompletionContributor {
  ...
  */
  ...
  private static void putKeywords(final CompletionResultSet result, TailType tail, @NonNls @NotNull String... words) {
    for (String s : words) {
      result.addElement(TailTypeDecorator.withTail(new PhizdetsLookupElement(s, true, null), tail));
    }
  }

  private static void putKeyword(@NotNull @NonNls String keyword, InsertHandler<PhizdetsLookupElement> handler, TailType tail,
                                 CompletionResultSet result) {
    final PhizdetsLookupElement lookupElement = new PhizdetsLookupElement(keyword, true, null);
  ...
  */
  ...
  private static class PyKeywordCompletionProvider extends CompletionProvider<CompletionParameters> {
    ...
    private final InsertHandler<PhizdetsLookupElement> myInsertHandler;
    ...
    private PyKeywordCompletionProvider(TailType tailType, @Nullable InsertHandler<PhizdetsLookupElement> insertHandler, String... keywords) {
      myKeywords = keywords;
      myTailType = tailType;
    ...
    protected void addCompletions(@NotNull final CompletionParameters parameters, final ProcessingContext context,
      ...
      for (String s : myKeywords) {
        final PhizdetsLookupElement element = new PhizdetsLookupElement(s, true, null);
