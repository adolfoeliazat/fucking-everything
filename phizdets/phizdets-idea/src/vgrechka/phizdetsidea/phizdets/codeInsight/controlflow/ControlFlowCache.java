 ...
 */
package vgrechka.phizdetsidea.phizdets.codeInsight.controlflow;

import com.intellij.codeInsight.controlflow.ControlFlow;
import com.intellij.openapi.util.Key;
import com.intellij.reference.SoftReference;
import vgrechka.phizdetsidea.phizdets.codeInsight.dataflow.scope.Scope;
import vgrechka.phizdetsidea.phizdets.codeInsight.dataflow.scope.impl.ScopeImpl;
...
public class ControlFlowCache {
  private static Key<SoftReference<ControlFlow>> CONTROL_FLOW_KEY = Key.create("vgrechka.phizdetsidea.phizdets.codeInsight.controlflow.ControlFlow");
  private static Key<SoftReference<Scope>> SCOPE_KEY = Key.create("vgrechka.phizdetsidea.phizdets.codeInsight.controlflow.Scope");
