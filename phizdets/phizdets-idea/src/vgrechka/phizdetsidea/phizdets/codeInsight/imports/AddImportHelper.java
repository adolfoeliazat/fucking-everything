...
import vgrechka.phizdetsidea.phizdets.formatter.PyBlock;
...
public class AddImportHelper {
  ...
  public static ImportPriority getImportPriority(@NotNull PsiElement importLocation, @NotNull PsiFileSystemItem toImport) {
    ...
    final Sdk phizdetsSdk = module != null ? PhizdetsSdkType.findPhizdetsSdk(module) : projectRootManager.getProjectSdk();

    return PhizdetsSdkType.isStdLib(vFile, phizdetsSdk) ? ImportPriority.BUILTIN : ImportPriority.THIRD_PARTY;
  }
