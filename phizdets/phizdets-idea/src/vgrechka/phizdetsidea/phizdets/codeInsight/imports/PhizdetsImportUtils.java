 ...
 * Date: 11-Mar-2008
 */
package vgrechka.phizdetsidea.phizdets.codeInsight.imports;
...
import vgrechka.phizdetsidea.phizdets.inspections.unresolvedReference.PyPackageAliasesProvider;
...
import vgrechka.phizdetsidea.phizdets.psi.stubs.PyVariableNameIndex;
...
public final class PhizdetsImportUtils {
  private PhizdetsImportUtils() {
  ...
  public static AutoImportQuickFix proposeImportFix(final PyElement node, PsiReference reference) {
    ...
    if (module != null && PhizdetsSdkType.findPhizdetsSdk(module) == null) {
      return null;
    }
  ...
  private static AutoImportQuickFix addCandidates(PyElement node, PsiReference reference, String refText, @Nullable String asName) {
    ...
    if (fix.getCandidates().isEmpty()|| fix.hasProjectImports() || Registry.is("phizdets.import.always.ask")) {
