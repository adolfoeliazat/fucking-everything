...
import vgrechka.phizdetsidea.phizdets.codeInsight.PyInjectionUtil;
 ...
 * @author yole
 */
public class PhizdetsRegexpInjector implements MultiHostInjector {
  ...
  private static void injectRegexpLanguage(@NotNull MultiHostRegistrar registrar, @NotNull PsiElement context, boolean verbose) {
    final Language language = verbose ? PhizdetsVerboseRegexpLanguage.INSTANCE : PhizdetsRegexpLanguage.INSTANCE;
