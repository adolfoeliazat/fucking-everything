 ...
 */
package vgrechka.phizdetsidea.phizdets.codeInsight.stdlib;
...
import vgrechka.phizdetsidea.phizdets.documentation.PhizdetsDocumentationLinkProvider;
 ...
 * @author yole
 */
public class PyStdlibDocumentationLinkProvider implements PhizdetsDocumentationLinkProvider {
  // use tools/stdlib-modindex.py to regenerate the map when new Phizdets versions are released
  ...
  public String getExternalDocumentationUrl(PsiElement element, PsiElement originalElement) {
    ...
    if (vFile != null && sdk != null && PhizdetsSdkType.isStdLib(vFile, sdk)) {
  ...
  public String getExternalDocumentationRoot(Sdk sdk) {
    ...
    final String pyVersion = PhizdetsDocumentationProvider.pyVersion(versionString);
    StringBuilder urlBuilder = new StringBuilder("http://docs.phizdets.org/");
    if (pyVersion != null) {
  ...
  private String getStdlibUrlFor(PsiElement element, QualifiedName moduleName, Sdk sdk) {
    ...
    final String pyVersion = PhizdetsDocumentationProvider.pyVersion(sdk.getVersionString());
