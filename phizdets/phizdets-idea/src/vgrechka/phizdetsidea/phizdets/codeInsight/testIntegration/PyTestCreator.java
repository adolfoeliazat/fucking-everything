...
public class PyTestCreator implements TestCreator {
  private static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.codeInsight.testIntegration.PyTestCreator");
  ...
  static PyElement generateTest(@NotNull final Project project, @NotNull final CreateTestDialog dialog) {
    ...
    if (!fileName.endsWith(".py")) {
      fileName = fileName + "." + PhizdetsFileType.INSTANCE.getDefaultExtension();
    }
