 ...
 * @author yole
 */
public class PhizdetsContentEntriesConfigurable extends ModuleAwareProjectConfigurable implements NonDefaultProjectConfigurable {
  public PhizdetsContentEntriesConfigurable(final Project project) {
