...
public class PySearchableOptionContributor extends SearchableOptionContributor {
  ...
  private static void processIntegratedTools(SearchableOptionProcessor processor) {
    final String configurableId = "vgrechka.phizdetsidea.phizdets.configuration.PyIntegratedToolsModulesConfigurable";
    final String displayName = "Phizdets Integrated Tools";
    ...
    processor.addOptions("Docstring format", displayName, "Docstring format",
                         configurableId, displayName, true);
    processor.addOptions("Analyze Phizdets code in docstrings", displayName, "Analyze Phizdets code in docstrings",
                         configurableId, displayName, true);
