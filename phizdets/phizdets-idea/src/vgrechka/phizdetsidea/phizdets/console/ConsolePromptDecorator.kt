 ...
 */
class ConsolePromptDecorator(private val myEditorEx: EditorEx, private val myConsoleData: PhizdetsConsoleData) : EditorLinePainter(), TextAnnotationGutterProvider {
  ...
  val indentPrompt: String
    get() =
    extend(if (myConsoleData.isIPhizdetsEnabled) {
