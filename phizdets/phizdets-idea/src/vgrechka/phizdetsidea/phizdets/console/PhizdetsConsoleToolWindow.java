 ...
 * @author traff
 */
public class PhizdetsConsoleToolWindow {
  ...
  public PhizdetsConsoleToolWindow(Project project) {
    myProject = project;
  }

  public static PhizdetsConsoleToolWindow getInstance(@NotNull Project project) {
    return project.getComponent(PhizdetsConsoleToolWindow.class);
  }
      ...
      public void stateChanged() {
        ...
        if (window != null) {
          ...
          if (visible && toolWindow.getContentManager().getContentCount() == 0) {
            PydevConsoleRunner runner = PhizdetsConsoleRunnerFactory.getInstance().createConsoleRunner(myProject, null);
            runner.run();
          }
        }
      }
  ...
  public static ToolWindow getToolWindow(Project project) {
    return ToolWindowManager.getInstance(project).getToolWindow(PhizdetsConsoleToolWindowFactory.Companion.getID());
  }
