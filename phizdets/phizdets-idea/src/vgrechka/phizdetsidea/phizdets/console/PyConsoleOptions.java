...
import vgrechka.phizdetsidea.phizdets.run.PhizdetsRunParams;
...
public class PyConsoleOptions implements PersistentStateComponent<PyConsoleOptions.State> {
  ...
  public PyConsoleSettings getPhizdetsConsoleSettings() {
    return myState.myPhizdetsConsoleState;
  }
  ...
  public boolean isIphizdetsEnabled(){
    return myState.myIphizdetsEnabled;
  }

  public void setIphizdetsEnabled(boolean enabled){
    myState.myIphizdetsEnabled = enabled;
  }
  ...
  public void loadState(State state) {
    ...
    myState.myPhizdetsConsoleState = state.myPhizdetsConsoleState;
    myState.myIphizdetsEnabled = state.myIphizdetsEnabled;
  }

  public static class State {
    public PyConsoleSettings myPhizdetsConsoleState = new PyConsoleSettings();

    public boolean myShowDebugConsoleByDefault = false;
    public boolean myIphizdetsEnabled = true;
  }

  @Tag("console-settings")
  public static class PyConsoleSettings implements PhizdetsRunParams {
    ...
    public void apply(AbstractPhizdetsRunConfigurationParams form) {
    ...
    public void reset(Project project, AbstractPhizdetsRunConfigurationParams form) {
      form.setEnvs(myEnvs);
