...
public class PyConsoleOptionsConfigurable extends SearchableConfigurable.Parent.Abstract implements Configurable.NoScroll{
  ...
  public static final String CONSOLE_SETTINGS_HELP_REFERENCE_PYTHON = "reference.project.settings.console.phizdets";
  ...
  protected Configurable[] buildConfigurables() {
    ...
    PyConsoleSpecificOptionsPanel phizdetsConsoleOptionsPanel = new PyConsoleSpecificOptionsPanel(myProject);
    result.add(createConsoleChildConfigurable("Phizdets Console", phizdetsConsoleOptionsPanel,
                                              myOptionsProvider.getPhizdetsConsoleSettings(), CONSOLE_SETTINGS_HELP_REFERENCE_PYTHON));
  ...
  private static class PyConsoleOptionsPanel {
    ...
    private JBCheckBox myIphizdetsEnabledCheckbox;
    ...
    public void apply() {
      ...
      myOptionsProvider.setIphizdetsEnabled(myIphizdetsEnabledCheckbox.isSelected());
    }

    public void reset() {
      myShowDebugConsoleByDefault.setSelected(myOptionsProvider.isShowDebugConsoleByDefault());
      myIphizdetsEnabledCheckbox.setSelected(myOptionsProvider.isIphizdetsEnabled());
    }

    public boolean isModified() {
      return myShowDebugConsoleByDefault.isSelected() != myOptionsProvider.isShowDebugConsoleByDefault() ||
             myIphizdetsEnabledCheckbox.isSelected()  != myOptionsProvider.isIphizdetsEnabled();
