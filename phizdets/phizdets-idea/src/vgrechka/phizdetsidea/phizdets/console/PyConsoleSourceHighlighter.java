...
class PyConsoleSourceHighlighter {
  ...
  private PhizdetsConsoleView myPhizdetsConsoleView;

  PyConsoleSourceHighlighter(PhizdetsConsoleView phizdetsConsoleView, EditorColorsScheme scheme, PyHighlighter pyHighlighter) {
    myPhizdetsConsoleView = phizdetsConsoleView;
    myScheme = scheme;
  ...
  public void printHighlightedSource(String text) {
    ...
    while (hasNext()) {
      ...
      myPhizdetsConsoleView.printText(pair.first, pair.second);
    }
  }
