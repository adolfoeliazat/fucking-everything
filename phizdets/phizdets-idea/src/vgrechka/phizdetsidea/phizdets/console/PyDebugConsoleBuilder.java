...
import vgrechka.phizdetsidea.phizdets.debugger.PyRunCythonExtensionsFilter;
import vgrechka.phizdetsidea.phizdets.run.PhizdetsTracebackFilter;
...
public class PyDebugConsoleBuilder extends TextConsoleBuilder {
  ...
  protected  ConsoleView createConsole() {
    PhizdetsDebugLanguageConsoleView consoleView = new PhizdetsDebugLanguageConsoleView(myProject, mySdk);
