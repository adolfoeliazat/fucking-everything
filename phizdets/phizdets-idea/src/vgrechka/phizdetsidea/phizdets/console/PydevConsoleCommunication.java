...
import vgrechka.phizdetsidea.phizdets.console.pydev.*;
import vgrechka.phizdetsidea.phizdets.debugger.*;
import vgrechka.phizdetsidea.phizdets.debugger.containerview.PyViewNumericContainerAction;
import vgrechka.phizdetsidea.phizdets.debugger.pydev.GetVariableCommand;
import vgrechka.phizdetsidea.phizdets.debugger.pydev.ProtocolParser;
...
public class PydevConsoleCommunication extends AbstractConsoleCommunication implements XmlRpcHandler,
  ...
  private PhizdetsDebugConsoleCommunication myDebugCommunication;
  ...
  public Object execute(String method, Vector params) throws Exception {
    ...
    else if ("IPhizdetsEditor".equals(method)) {
      return execIPhizdetsEditor(params);
    }
  ...
  private Object execNotifyAboutMagic(Vector params) {
    ...
    if (getConsoleFile() != null) {
      PhizdetsConsoleData consoleData = PyConsoleUtil.getOrCreateIPhizdetsData(getConsoleFile());
      consoleData.setIPhizdetsAutomagic(isAutoMagic);
      consoleData.setIPhizdetsMagicCommands(commands);
    }

    return "";
  }

  private Object execIPhizdetsEditor(Vector params) {
  ...
  public void setDebugCommunication(PhizdetsDebugConsoleCommunication debugCommunication) {
    myDebugCommunication = debugCommunication;
  }

  public PhizdetsDebugConsoleCommunication getDebugCommunication() {
  ...
  public void setConsoleView(PhizdetsConsoleView consoleView) {
