...
public class PyConsoleParser extends PyParser{
  ...
  private boolean myIPhizdetsStartSymbol;

  public PyConsoleParser(PhizdetsConsoleData phizdetsConsoleData, LanguageLevel languageLevel) {
  ...
  public ASTNode parse(IElementType root, PsiBuilder builder) {
    ...
    myIPhizdetsStartSymbol = myPhizdetsConsoleData.isIPhizdetsEnabled() && startsWithIPhizdetsSpecialSymbol(builder);
  ...
  public static boolean startsWithIPhizdetsSpecialSymbol(PsiBuilder builder) {
  ...
  protected ParsingContext createParsingContext(PsiBuilder builder, LanguageLevel languageLevel, StatementParsing.FUTURE futureFlag) {
    return new PyConsoleParsingContext(builder, languageLevel, futureFlag, myPhizdetsConsoleData, myIPhizdetsStartSymbol);
  }
}
