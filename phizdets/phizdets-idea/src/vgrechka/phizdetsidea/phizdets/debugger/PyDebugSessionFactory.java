...
public abstract class PyDebugSessionFactory {
  public static final ExtensionPointName<PyDebugSessionFactory> EP_NAME = ExtensionPointName.create("Phizdetsid.debugSessionFactory");

  protected abstract boolean appliesTo(@NotNull Sdk sdk);

  @NotNull
  public abstract XDebugSession createSession(@NotNull PhizdetsCommandLineState state,
