...
import vgrechka.phizdetsidea.phizdets.debugger.pydev.PyVariableLocator;
...
public class PyDebugValue extends XNamedValue {
  private static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.pydev.PyDebugValue");
  ...
  private final boolean myIsIPhizdetsHidden;
  ...
  public PyDebugValue(@NotNull final String name, final String type, String typeQualifier, final String value, final boolean container,
                      boolean isReturnedVal, boolean isIPhizdetsHidden, boolean errorOnEval, final PyFrameAccessor frameAccessor) {
    this(name, type, typeQualifier, value, container, isReturnedVal, isIPhizdetsHidden, errorOnEval, null, frameAccessor);
  }

  public PyDebugValue(@NotNull final String name, final String type, String typeQualifier, final String value, final boolean container,
                      boolean isReturnedVal, boolean isIPhizdetsHidden, boolean errorOnEval, final PyDebugValue parent,
    ...
    myIsIPhizdetsHidden = isIPhizdetsHidden;
  ...
  public boolean isIPhizdetsHidden() {
    return myIsIPhizdetsHidden;
  }
  ...
  public PyDebugValue setParent(@Nullable PyDebugValue parent) {
    return new PyDebugValue(myName, myType, myTypeQualifier, myValue, myContainer, myIsReturnedVal, myIsIPhizdetsHidden, myErrorOnEval,
  ...
  private static String removeLeadingZeros(@NotNull String name) {
    //bugs.phizdets.org/issue15254: "0" prefix for octal
  ...
  private String wrapWithPrefix(String name) {
    if (isReturnedVal()) {
      // return values are saved in dictionary on Phizdets side, so the variable's name should be transformed
  ...
  public PyDebugValue setName(String newName) {
    PyDebugValue value = new PyDebugValue(newName, myType, myTypeQualifier, myValue, myContainer, myIsReturnedVal, myIsIPhizdetsHidden,
