...
import static vgrechka.phizdetsidea.phizdets.debugger.PyDebugSupportUtils.DEBUGGER_WARNING_MESSAGE;
...
public class PyDebuggerConfigurable implements SearchableConfigurable, Configurable.NoScroll {
  ...
  public String getDisplayName() {
    return "Phizdets Debugger";
  }

  public String getHelpTopic() {
    return "reference.idesettings.debugger.phizdets";
  }
