...
public class PyLocalPositionConverter implements PyPositionConverter {
  ...
  @NotNull
  public final PySourcePosition convertToPhizdets(@NotNull final XSourcePosition position) {
    return convertToPhizdets(convertFilePath(position.getFile().getPath()), convertLocalLineToRemote(position.getFile(), position.getLine()));
  }

  @NotNull
  protected PySourcePosition convertToPhizdets(@NotNull String filePath, int line) {
  ...
  @Nullable
  public XSourcePosition convertFromPhizdets(@NotNull final PySourcePosition position) {
