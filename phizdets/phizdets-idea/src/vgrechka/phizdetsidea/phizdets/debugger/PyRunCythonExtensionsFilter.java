...
public class PyRunCythonExtensionsFilter implements Filter {
  ...
  private static final Logger LOG = Logger.getInstance("vgrechka.phizdetsidea.phizdets.debugger.PyRunCythonExtensionsFilter");
    ...
    public void navigate(Project project) {
      try {
        ...
        if (selectedConfiguration == null) {
          throw new ExecutionException("Phizdets Run Configuration should be selected");
        }
        ...
        final String helpersPath = PhizdetsHelpersLocator.getHelpersRoot().getPath();
        ...
        if (sdkPath != null) {
          PhizdetsEnvUtil.resetHomePathChanges(sdkPath, environment);
        }
