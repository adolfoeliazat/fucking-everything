 ...
 */
package vgrechka.phizdetsidea.phizdets.debugger.array;
...
public class ArrayTableCellEditor extends AbstractCellEditor implements TableCellEditor {
  ...
  private static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.debugger.array.ArrayTableCellEditor");
  ...
  public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected,
    ...
    myEditor = new MyTableEditor(myProject, new PyDebuggerEditorsProvider(), "numpy.array.table.view", null,
                                 new XExpressionImpl(value.toString(), PhizdetsLanguage.getInstance(), "", EvaluationMode.CODE_FRAGMENT),
