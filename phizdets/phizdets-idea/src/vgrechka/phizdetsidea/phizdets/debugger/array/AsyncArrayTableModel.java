...
import vgrechka.phizdetsidea.phizdets.debugger.ArrayChunkBuilder;
...
public class AsyncArrayTableModel extends AbstractTableModel {
  ...
  private final ExecutorService myExecutorService = ConcurrencyUtil.newSingleThreadExecutor("Phizdets async table");
