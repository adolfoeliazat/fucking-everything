...
import vgrechka.phizdetsidea.phizdets.debugger.array.JBTableWithRowHeaders;
...
public class PyDataViewerPanel extends JPanel {
  ...
  private EditorTextField createEditorField() {
    return new EditorTextField(EditorFactory.getInstance().createDocument(""), myProject, PhizdetsFileType.INSTANCE, false, true) {
      @Override
