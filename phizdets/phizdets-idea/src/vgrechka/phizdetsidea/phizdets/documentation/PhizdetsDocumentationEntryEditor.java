 ...
 * @author yole
 */
public class PhizdetsDocumentationEntryEditor extends DialogWrapper {
  ...
  public PhizdetsDocumentationEntryEditor(Component parent) {
    super(parent, true);
    init();
  ...
  public PhizdetsDocumentationMap.Entry getEntry() {
    return new PhizdetsDocumentationMap.Entry(myNameField.getText(), myURLPatternTextField.getText());
  }

  public void setEntry(PhizdetsDocumentationMap.Entry entry) {
