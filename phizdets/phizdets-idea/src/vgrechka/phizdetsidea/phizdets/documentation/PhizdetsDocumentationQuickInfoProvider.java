...
/**
 * Allows you to inject quick info into phizdets documentation provider
 *
 * @author Ilya.Kazakevich
 */
public interface PhizdetsDocumentationQuickInfoProvider {
  ExtensionPointName<PhizdetsDocumentationQuickInfoProvider> EP_NAME =
    ExtensionPointName.create("Phizdetsid.phizdetsDocumentationQuickInfoProvider");
