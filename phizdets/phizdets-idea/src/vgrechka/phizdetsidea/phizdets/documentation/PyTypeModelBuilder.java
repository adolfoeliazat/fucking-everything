...
import static vgrechka.phizdetsidea.phizdets.documentation.DocumentationBuilderKit.combUp;
  ...
  private static class TypeToBodyWithLinksVisitor extends TypeNameVisitor {
    ...
    protected void addType(String name) {
      ...
      if (type instanceof PyClassType) {
        myBody.addWith(new DocumentationBuilderKit.LinkWrapper(PhizdetsDocumentationProvider.LINK_TYPE_TYPENAME + name), $(name));
      }
      else {
        add(name);
      }
