...
public class DocStringUtil {
  ...
  /**
   * Checks that docstring format is set either via element module's {@link vgrechka.phizdetsidea.phizdets.PyNames.DOCFORMAT} attribute or
  ...
  // For instance, an empty IDEA project with a Phizdets scratch file.
  @Nullable
