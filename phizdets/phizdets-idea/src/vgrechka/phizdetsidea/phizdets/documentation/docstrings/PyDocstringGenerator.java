...
public class PyDocstringGenerator {
   ...
   *                       It's needed to detect configured docstring format and Phizdets indentation size and, as result,
   ...
   *                  possible, e.g. in  {@link vgrechka.phizdetsidea.phizdets.editor.PhizdetsEnterHandler} where unclosed docstring literal
