 ...
 * User : catherine
 */
public class PhizdetsCopyPasteProcessor implements CopyPastePreProcessor {
  ...
  public String preprocessOnCopy(PsiFile file, int[] startOffsets, int[] endOffsets, String text) {
    if (!CodeInsightSettings.getInstance().INDENT_TO_CARET_ON_PASTE || file.getLanguage() != PhizdetsLanguage.getInstance()) {
      return null;
    }
