 ...
 */
package vgrechka.phizdetsidea.phizdets.editor;
...
import vgrechka.phizdetsidea.phizdets.editor.PhizdetsEnterHandler.DocstringState;
 ...
 * User : catherine
 */
public class PhizdetsSpaceHandler extends TypedHandlerDelegate {
  @Override
  public Result charTyped(char c, Project project, @NotNull Editor editor, @NotNull PsiFile file) {
    ...
    if (c == ' ' && codeInsightSettings.JAVADOC_STUB_ON_ENTER) {
      ...
      if (PhizdetsEnterHandler.canGenerateDocstring(element, expectedStringStart, document) == DocstringState.INCOMPLETE) {
