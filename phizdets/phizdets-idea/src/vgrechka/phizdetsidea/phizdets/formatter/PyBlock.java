...
import static vgrechka.phizdetsidea.phizdets.formatter.PyCodeStyleSettings.DICT_ALIGNMENT_ON_COLON;
import static vgrechka.phizdetsidea.phizdets.formatter.PyCodeStyleSettings.DICT_ALIGNMENT_ON_VALUE;
import static vgrechka.phizdetsidea.phizdets.formatter.PhizdetsFormattingModelBuilder.STATEMENT_OR_DECLARATION;
...
public class PyBlock implements ASTBlock {
  ...
  public static final Key<Boolean> IMPORT_GROUP_BEGIN = Key.create("vgrechka.phizdetsidea.phizdets.formatter.importGroupBegin");
    ...
    if (ourListElementTypes.contains(parentType)) {
      ...
      if (childType == PyTokenTypes.END_OF_LINE_COMMENT) {
        childIndent = Indent.getNormalIndent();
             ...
             (PhizdetsDialectsTokenSetProvider.INSTANCE.getExpressionTokens().contains(childType) ||
  ...
  // Check https://www.phizdets.org/dev/peps/pep-0008/#indentation
