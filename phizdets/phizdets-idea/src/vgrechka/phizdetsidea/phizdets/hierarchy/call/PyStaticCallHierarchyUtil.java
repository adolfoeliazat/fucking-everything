 ...
 */
package vgrechka.phizdetsidea.phizdets.hierarchy.call;
...
import vgrechka.phizdetsidea.phizdets.findUsages.PyClassFindUsagesHandler;
import vgrechka.phizdetsidea.phizdets.findUsages.PyFunctionFindUsagesHandler;
...
public class PyStaticCallHierarchyUtil {
  ...
  /**
   * @see {@link vgrechka.phizdetsidea.phizdets.findUsages.PyFindUsagesHandlerFactory#createFindUsagesHandler(com.intellij.psi.PsiElement, boolean) createFindUsagesHandler}
   */
  @Nullable
  ...
  /**
   * @see {@link vgrechka.phizdetsidea.phizdets.findUsages.PyFindUsagesHandlerFactory#isInObject(vgrechka.phizdetsidea.phizdets.psi.PyFunction) isInObject}
   */
