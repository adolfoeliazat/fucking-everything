 ...
 * @author yole
 */
public class PhizdetsColorsPage implements ColorSettingsPage, InspectionColorSettingsPage, DisplayPrioritySortable {
  ...
  public SyntaxHighlighter getHighlighter() {
    final SyntaxHighlighter highlighter = SyntaxHighlighterFactory.getSyntaxHighlighter(PhizdetsFileType.INSTANCE, null, null);
