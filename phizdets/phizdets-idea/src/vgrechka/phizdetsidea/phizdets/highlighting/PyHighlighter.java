 ...
 */
package vgrechka.phizdetsidea.phizdets.highlighting;
...
import vgrechka.phizdetsidea.phizdets.lexer.PyStringLiteralLexer;
import vgrechka.phizdetsidea.phizdets.lexer.PhizdetsHighlightingLexer;
...
public class PyHighlighter extends SyntaxHighlighterBase {
  ...
  protected PhizdetsHighlightingLexer createHighlightingLexer(LanguageLevel languageLevel) {
    return new PhizdetsHighlightingLexer(myLanguageLevel);
  }
  ...
  public PyHighlighter(LanguageLevel languageLevel) {
    ...
    fillMap(keys, PhizdetsDialectsTokenSetProvider.INSTANCE.getKeywordTokens(), PY_KEYWORD);
