...
import vgrechka.phizdetsidea.phizdets.inspections.quickfix.PyMoveAttributeToInitQuickFix;
import vgrechka.phizdetsidea.phizdets.psi.Property;
...
import vgrechka.phizdetsidea.phizdets.psi.impl.PyClassImpl;
...
public class PyAttributeOutsideInitInspection extends PyInspection {
  ...
  private static boolean isApplicable(@NotNull PyClass containingClass, @NotNull TypeEvalContext context) {
    return !PhizdetsUnitTestUtil.isUnitTestCaseClass(containingClass) && !containingClass.isSubclass("django.db.models.base.Model", context);
  }
}
