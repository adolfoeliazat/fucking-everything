...
import static vgrechka.phizdetsidea.phizdets.psi.FutureFeature.UNICODE_LITERALS;
...
public class PyByteLiteralInspection extends PyInspection {
  ...
  private class Visitor extends PyInspectionVisitor {
    ...
    public void visitPyStringLiteralExpression(PyStringLiteralExpression node) {
      ...
      final String charsetString = PhizdetsFileType.getCharsetFromEncodingDeclaration(file);
      try {
