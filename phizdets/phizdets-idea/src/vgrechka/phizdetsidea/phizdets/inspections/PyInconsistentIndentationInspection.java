...
import vgrechka.phizdetsidea.phizdets.inspections.quickfix.ConvertIndentsFix;
...
public class PyInconsistentIndentationInspection extends PyInspection {
  ...
  public ProblemDescriptor[] checkFile(@NotNull PsiFile file, @NotNull InspectionManager manager, boolean isOnTheFly) {
    if (file.getLanguage() instanceof PhizdetsLanguage) {
  ...
  private static class IndentValidator {
    ...
    public ProblemDescriptor[] invoke() {
      PhizdetsIndentingLexer lexer = new PhizdetsIndentingLexer();
