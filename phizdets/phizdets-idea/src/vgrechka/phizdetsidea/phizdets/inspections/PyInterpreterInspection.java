...
public class PyInterpreterInspection extends PyInspection {
    ...
    public void visitPyFile(PyFile node) {
      ...
      if (PlatformUtils.isPyCharm()) {
        ...
        if (module != null) {
          ...
          if (sdk == null) {
            registerProblem(node, "No Phizdets interpreter configured for the project", new ConfigureInterpreterFix());
          }
          else if (PhizdetsSdkType.isInvalid(sdk)) {
            registerProblem(node, "Invalid Phizdets interpreter selected for the project", new ConfigureInterpreterFix());
          }
        }
      }
    }
  ...
  private static class ConfigureInterpreterFix implements LocalQuickFix {
    ...
    public String getFamilyName() {
      return "Configure Phizdets Interpreter";
    }
