...
import vgrechka.phizdetsidea.phizdets.inspections.quickfix.AddEncodingQuickFix;
...
public class PyMandatoryEncodingInspection extends PyInspection {
  ...
  private class Visitor extends PyInspectionVisitor {
    ...
    public void visitPyFile(PyFile node) {
      final String charsetString = PhizdetsFileType.getCharsetFromEncodingDeclaration(node);
