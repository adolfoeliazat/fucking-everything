...
import vgrechka.phizdetsidea.phizdets.codeInsight.stdlib.PyStdlibUtil;
import vgrechka.phizdetsidea.phizdets.packaging.*;
import vgrechka.phizdetsidea.phizdets.packaging.ui.PyChooseRequirementsDialog;
...
public class PyPackageRequirementsInspection extends PyInspection {
    ...
    public void applyFix(@NotNull final Project project, @NotNull ProblemDescriptor descriptor) {
      ...
      if (!PyPackageUtil.hasManagement(packages)) {
        final int result = Messages.showYesNoDialog(project,
                                                    "Phizdets packaging tools are required for installing packages. Do you want to " +
                                                    "install 'pip' and 'setuptools' for your interpreter?",
                                                    "Install Phizdets Packaging Tools",
  ...
  public static class InstallAndImportQuickFix implements LocalQuickFix {
    ...
    public InstallAndImportQuickFix(@NotNull final String packageName,
      ...
      mySdk = PhizdetsSdkType.findPhizdetsSdk(myModule);
    }
