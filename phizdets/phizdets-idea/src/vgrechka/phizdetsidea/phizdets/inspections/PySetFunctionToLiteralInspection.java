...
import vgrechka.phizdetsidea.phizdets.inspections.quickfix.ReplaceFunctionWithSetLiteralQuickFix;
      ...
      if (inspectionTool != null) {
        ...
        if (inspection instanceof PyCompatibilityInspection) {
          ...
          for (String s : versions) {
            if (!LanguageLevel.fromPhizdetsVersion(s).supportsSetLiterals()) return false;
          }
        }
      }
