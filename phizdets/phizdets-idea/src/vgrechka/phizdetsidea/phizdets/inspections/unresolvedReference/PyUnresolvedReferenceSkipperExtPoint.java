...
import vgrechka.phizdetsidea.phizdets.psi.PyImportedNameDefiner;
...
public interface PyUnresolvedReferenceSkipperExtPoint {
  @NotNull
  ExtensionPointName<PyUnresolvedReferenceSkipperExtPoint> EP_NAME = ExtensionPointName.create("Phizdetsid.unresolvedReferenceSkipper");
