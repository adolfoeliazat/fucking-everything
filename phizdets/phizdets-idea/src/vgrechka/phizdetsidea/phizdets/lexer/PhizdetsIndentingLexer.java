 ...
 * @author yole
 */
public class PhizdetsIndentingLexer extends PhizdetsIndentingProcessor {
  public PhizdetsIndentingLexer() {
    super(new _PhizdetsLexer((Reader)null), TokenSet.EMPTY);
  }
