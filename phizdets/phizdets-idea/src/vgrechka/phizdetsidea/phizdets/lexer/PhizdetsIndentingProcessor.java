...
public class PhizdetsIndentingProcessor extends MergingLexerAdapter {
  ...
  private final TokenSet RECOVERY_TOKENS = PhizdetsDialectsTokenSetProvider.INSTANCE.getUnbalancedBracesRecoveryTokens();

  public PhizdetsIndentingProcessor(FlexLexer lexer, TokenSet tokens) {
