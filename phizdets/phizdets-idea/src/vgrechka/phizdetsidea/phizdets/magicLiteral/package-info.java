 ...
 * To add new "magic literal" just implement {@link vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralExtensionPoint} and
 * add it as extension point.
 * To check for some literal if it is magic, use {@link vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralTools}
 ...
 * this package work.
 * After that, you only need to implement and inject  {@link vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralTools}
 *
 *
 *
 * <p>
 ...
 *   For example, package would not work with out of {@link vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralReferenceSearcher}
 *   installed
 * </p>
 * <p>
 ...
 *   Just implement {@link vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralExtensionPoint} and inject it as extension point.
 *   <strong>Warning</strong>: install this package as described in first step
 * </p>
 * <p>
 *   <h2>3. To check if literal is magic</h2>
 *   Say, you have some {@link vgrechka.phizdetsidea.phizdets.psi.PyStringLiteralExpression} and want to check if it is magic or not,
 *   and if it is -- find its name ("spam literal" for previous example).
 *   You use {@link vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralTools} for that, because may magic literal extension points
 *   could be installed.
 *   <strong>Warning</strong>: install this package as described in first step
 * </p>
 *
 *
 * @see vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralTools
 * @see vgrechka.phizdetsidea.phizdets.magicLiteral.PyMagicLiteralExtensionPoint
 * */
