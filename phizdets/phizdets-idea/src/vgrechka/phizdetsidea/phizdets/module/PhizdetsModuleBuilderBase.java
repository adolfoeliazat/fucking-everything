 ...
 */
package vgrechka.phizdetsidea.phizdets.module;
 ...
 * @author yole
 */
public class PhizdetsModuleBuilderBase extends ModuleBuilder {
  ...
  public PhizdetsModuleBuilderBase() {
    myGenerator = null;
  }

  public PhizdetsModuleBuilderBase(DirectoryProjectGenerator generator) {
  ...
  public ModuleType getModuleType() {
    return PhizdetsModuleTypeBase.getInstance();
  }
  ...
  public boolean isSuitableSdkType(SdkTypeId sdk) {
    return sdk instanceof PhizdetsSdkType;
  }
