...
public abstract class PyModuleService {
  ...
  /**
   * Creates a ModuleBuilder that creates a Phizdets module and runs the specified DirectoryProjectGenerator to perform
   ...
   */
  public abstract ModuleBuilder createPhizdetsModuleBuilder(DirectoryProjectGenerator generator);
}
