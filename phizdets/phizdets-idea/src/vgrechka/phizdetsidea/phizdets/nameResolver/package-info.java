 ...
 * So, you need to:
 * <ol>
 *   <li>Create some enum that implements {@link vgrechka.phizdetsidea.phizdets.nameResolver.FQNamesProvider} (see its javadoc for more info)</li>
 *   <li>Use {@link vgrechka.phizdetsidea.phizdets.nameResolver.NameResolverTools#isName(vgrechka.phizdetsidea.phizdets.psi.PyElement, FQNamesProvider)}
 *   to check that some element matches some names from that enum</li>
 * </ol>
 * @author Ilya.Kazakevich
 */
package vgrechka.phizdetsidea.phizdets.nameResolver;