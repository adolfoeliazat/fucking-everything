 ...
 */
package vgrechka.phizdetsidea.phizdets.packaging.setupPy;
...
import vgrechka.phizdetsidea.phizdets.run.PhizdetsTask;
...
public class SetupTaskChooserAction extends AnAction {
  ...
  public void update(AnActionEvent e) {
    final Module module = e.getData(LangDataKeys.MODULE);
    e.getPresentation().setEnabled(module != null && PyPackageUtil.hasSetupPy(module) && PhizdetsSdkType.findPhizdetsSdk(module) != null);
  }
  ...
  public static void runSetupTask(String taskName, Module module, List<String> parameters) {
    try {
      ...
      final PhizdetsTask task = new PhizdetsTask(module, taskName);
