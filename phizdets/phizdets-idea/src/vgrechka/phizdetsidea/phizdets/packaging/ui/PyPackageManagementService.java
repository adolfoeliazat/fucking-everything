 ...
 */
package vgrechka.phizdetsidea.phizdets.packaging.ui;
...
import vgrechka.phizdetsidea.phizdets.packaging.*;
import vgrechka.phizdetsidea.phizdets.packaging.PyPIPackageUtil.PackageDetails;
import vgrechka.phizdetsidea.phizdets.packaging.requirement.PyRequirementRelation;
...
public class PyPackageManagementService extends PackageManagementServiceEx {
  ...
  public boolean canInstallToUser() {
    return !PhizdetsSdkType.isVirtualEnv(mySdk);
  }
  ...
  public String getInstallToUserText() {
    ...
    if (!PhizdetsSdkType.isRemote(mySdk))
  ...
  private static String findErrorSolution(@NotNull PyExecutionException e, @Nullable String cause, @Nullable Sdk sdk) {
    if (cause != null) {
      if (StringUtil.containsIgnoreCase(cause, "SyntaxError")) {
        ...
        return "Make sure that you use a version of Phizdets supported by this package. Currently you are using Phizdets " +
               languageLevel + ".";
      }
    }

    if (SystemInfo.isLinux && (containsInOutput(e, "pyconfig.h") || containsInOutput(e, "Phizdets.h"))) {
      return "Make sure that you have installed Phizdets development packages for your operating system.";
    }
    ...
    if ("pip".equals(e.getCommand()) && sdk != null) {
      return "Try to run this command from the system terminal. Make sure that you use the correct version of 'pip' " +
             "installed for your Phizdets interpreter located at '" + sdk.getHomePath() + "'.";
    }
