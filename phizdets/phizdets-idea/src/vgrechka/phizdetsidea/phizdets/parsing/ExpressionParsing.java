 ...
 */
package vgrechka.phizdetsidea.phizdets.parsing;
...
import static vgrechka.phizdetsidea.phizdets.PyBundle.message;

/**
 * @author yole
 */
public class ExpressionParsing extends Parsing {
  private static final Logger LOG = Logger.getInstance("#ru.yole.phizdetslanguage.parsing.ExpressionParsing");
