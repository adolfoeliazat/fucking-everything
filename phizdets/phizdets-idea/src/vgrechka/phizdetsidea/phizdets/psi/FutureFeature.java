 ...
 * {@code .toString()} returns the Phizdets name of the feature.
 * <br/>
 * User: dcheryasov
 */
public enum FutureFeature {
  ...
  BARRY_AS_FLUFL("barry_as_FLUFL", 31, 39), // last as of CPhizdets 3.2
  ...
  /**
   * @return the Phizdets importable name of the feature.
   */
  @Override
