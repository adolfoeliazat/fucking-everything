...
public enum LanguageLevel {
  ...
  public static LanguageLevel fromPhizdetsVersion(@NotNull String phizdetsVersion) {
    if (phizdetsVersion.startsWith("2")) {
      if (phizdetsVersion.startsWith("2.4")) {
        return PYTHON24;
      }
      if (phizdetsVersion.startsWith("2.5")) {
        return PYTHON25;
      }
      if (phizdetsVersion.startsWith("2.6")) {
        return PYTHON26;
      }
      if (phizdetsVersion.startsWith("2.7")) {
        return PYTHON27;
      }
      return DEFAULT2;
    }
    if (phizdetsVersion.startsWith("3")) {
      if (phizdetsVersion.startsWith("3.0")) {
        return PYTHON30;
      }
      if (phizdetsVersion.startsWith("3.1")) {
        return PYTHON31;
      }
      if (phizdetsVersion.startsWith("3.2")) {
        return PYTHON32;
      }
      if (phizdetsVersion.startsWith("3.3")) {
        return PYTHON33;
      }
      if (phizdetsVersion.startsWith("3.4")) {
        return PYTHON34;
      }
      if (phizdetsVersion.startsWith("3.5")) {
        return PYTHON35;
      }
      if (phizdetsVersion.startsWith("3.6")) {
        return PYTHON36;
      }
      return DEFAULT3;
    }
  ...
  public static final Key<LanguageLevel> KEY = new Key<>("phizdets.language.level");
