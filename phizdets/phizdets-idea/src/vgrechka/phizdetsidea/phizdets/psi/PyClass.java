...
public interface PyClass extends PsiNameIdentifierOwner, PyStatement, PyDocStringOwner, StubBasedPsiElement<PyClassStub>,
   ...
   * are searched for and called by Phizdets when a constructor call is made.
   ...
   * <p/>
   * The metaclass might be defined outside the class in case of Phizdets 2 file-level __metaclass__ attributes.
   */
  @Nullable
