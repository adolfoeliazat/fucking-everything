...
public interface PyFromImportStatement extends PyImportStatementBase, StubBasedPsiElement<PyFromImportStatementStub>,
  ...
  /**
   * Resolves the import source qualified name to a file or directory. Note: performs a Phizdets only resolve,
  ...
  /**
   * Resolves the import source qualified name to a number of possible files or directories. Note: performs a Phizdets only resolve,
   * doesn't handle extension points such as import from Java classes.
   *
