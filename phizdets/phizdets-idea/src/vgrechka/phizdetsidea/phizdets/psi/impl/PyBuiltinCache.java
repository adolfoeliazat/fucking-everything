...
/**
 * Provides access to Phizdets builtins via skeletons.
 */
public class PyBuiltinCache {
  ...
  public static PyBuiltinCache getInstance(@Nullable PsiElement reference) {
    if (reference != null) {
      try {
        ...
        if (sdk != null) {
          return PhizdetsSdkPathCache.getInstance(reference.getProject(), sdk).getBuiltins();
        }
      }
      ...
      if (sdk == null) {
        ...
        for (OrderEntry orderEntry : orderEntries) {
          if (orderEntry instanceof JdkOrderEntry) {
            ...
            sdk = PhizdetsSdkType.findPhizdetsSdk(orderEntry.getOwnerModule());
          }
        }
      }
    }
  ...
  public static PyFile getBuiltinsForSdk(@NotNull Project project, @NotNull Sdk sdk) {
    return getSkeletonFile(project, sdk, PhizdetsSdkType.getBuiltinsFileName(sdk));
  }
  ...
  private static PyFile getSkeletonFile(final @NotNull Project project, @NotNull Sdk sdk, @NotNull String name) {
    ...
    if (sdkType instanceof PhizdetsSdkType) {
