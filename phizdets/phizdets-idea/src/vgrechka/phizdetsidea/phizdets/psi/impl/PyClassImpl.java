...
import vgrechka.phizdetsidea.phizdets.psi.impl.stubs.PyClassElementType;
...
import vgrechka.phizdetsidea.phizdets.psi.stubs.PropertyStubStorage;
...
public class PyClassImpl extends PyBaseElementImpl<PyClassStub> implements PyClass {
  ...
  public PyFunction[] getMethods() {
    return getClassChildren(PhizdetsDialectsTokenSetProvider.INSTANCE.getFunctionDeclarationTokens(), PyFunction.ARRAY_FACTORY);
  }
