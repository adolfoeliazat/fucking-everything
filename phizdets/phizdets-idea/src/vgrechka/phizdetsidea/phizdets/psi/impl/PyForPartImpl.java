...
public class PyForPartImpl extends PyStatementPartImpl implements PyForPart {
  ...
  public PyExpression getTarget() {
    ASTNode n = getNode().findChildByType(PhizdetsDialectsTokenSetProvider.INSTANCE.getExpressionTokens());
  ...
  public PyExpression getSource() {
    List<PsiElement> exprs = findChildrenByType(PhizdetsDialectsTokenSetProvider.INSTANCE.getExpressionTokens());
