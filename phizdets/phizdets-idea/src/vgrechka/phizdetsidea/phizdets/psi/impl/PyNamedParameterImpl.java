...
import vgrechka.phizdetsidea.phizdets.psi.stubs.PyNamedParameterStub;
...
public class PyNamedParameterImpl extends PyBaseElementImpl<PyNamedParameterStub> implements PyNamedParameter {
  ...
  public PyExpression getDefaultValue() {
    ...
    ASTNode[] nodes = getNode().getChildren(PhizdetsDialectsTokenSetProvider.INSTANCE.getExpressionTokens());
    if (nodes.length > 0) {
  ...
  public String getRepr(boolean includeDefaultValue, @Nullable TypeEvalContext context) {
    ...
    if (context != null) {
      ...
      if (argumentType != null) {
        sb.append(": ");
        sb.append(PhizdetsDocumentationProvider.getTypeDescription(argumentType, context));
      }
    }
