...
import vgrechka.phizdetsidea.phizdets.console.completion.PydevConsoleReference;
...
import vgrechka.phizdetsidea.phizdets.refactoring.PyDefUseUtil;
...
public class PyReferenceExpressionImpl extends PyElementImpl implements PyReferenceExpression {
  ...
  private static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.psi.impl.PyReferenceExpressionImpl");
  ...
  public PyExpression getQualifier() {
    final ASTNode[] nodes = getNode().getChildren(PhizdetsDialectsTokenSetProvider.INSTANCE.getExpressionTokens());
