...
import vgrechka.phizdetsidea.phizdets.psi.impl.references.PyTargetReference;
...
public class PyTargetExpressionImpl extends PyBaseElementImpl<PyTargetExpressionStub> implements PyTargetExpression {
  ...
  public PyExpression getQualifier() {
    ASTNode qualifier = getNode().findChildByType(PhizdetsDialectsTokenSetProvider.INSTANCE.getExpressionTokens());
