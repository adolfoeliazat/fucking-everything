 ...
 */
package vgrechka.phizdetsidea.phizdets.psi.impl.blockEvaluator;
...
import vgrechka.phizdetsidea.phizdets.psi.impl.PyEvaluator;
import vgrechka.phizdetsidea.phizdets.psi.impl.PyPathEvaluator;
...
public class PyBlockEvaluator {
  ...
  /**
   * @param evaluationContext context, obtained via {@link #getContext()}. Pass it here to enable cache. See {@link vgrechka.phizdetsidea.phizdets.psi.impl.blockEvaluator.PyEvaluationContext}
   *                          for more info
   * @see vgrechka.phizdetsidea.phizdets.psi.impl.blockEvaluator.PyEvaluationContext
   */
  ...
  /**
   * @return so-called context. You may pass it to any instance of {@link vgrechka.phizdetsidea.phizdets.psi.impl.blockEvaluator.PyBlockEvaluator}
