...
import vgrechka.phizdetsidea.phizdets.psi.FutureFeature;
...
public class PyFileStubImpl extends PsiFileStubImpl<PyFile> implements PyFileStub {
  ...
  public IStubFileElementType getType() {
    return (IStubFileElementType) LanguageParserDefinitions.INSTANCE.forLanguage(PhizdetsLanguage.getInstance()).getFileNodeType();
  }
}
