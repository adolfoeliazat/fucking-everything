...
import vgrechka.phizdetsidea.phizdets.psi.impl.PyTargetExpressionImpl;
import vgrechka.phizdetsidea.phizdets.psi.stubs.*;
...
public class PyTargetExpressionElementType extends PyStubElementType<PyTargetExpressionStub, PyTargetExpression> {
  ...
  public boolean shouldCreateStub(final ASTNode node) {
    ...
    final ASTNode qualifierNode = node.findChildByType(PhizdetsDialectsTokenSetProvider.INSTANCE.getReferenceExpressionTokens());
