...
public interface QualifiedResolveResult extends ResolveResult {
   ...
   *
   * @see vgrechka.phizdetsidea.phizdets.psi.PyReferenceExpression#followAssignmentsChain(PyResolveContext)
   * @see vgrechka.phizdetsidea.phizdets.psi.PyReferenceExpression#multiFollowAssignmentsChain(PyResolveContext)
   */
  @NotNull
