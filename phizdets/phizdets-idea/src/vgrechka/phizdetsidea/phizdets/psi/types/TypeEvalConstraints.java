...
/**
 * A pack of constraints that limit behavior of {@link vgrechka.phizdetsidea.phizdets.psi.types.TypeEvalContext}.
 * Any two  {@link vgrechka.phizdetsidea.phizdets.psi.types.TypeEvalContext}s may share their cache if their constraints are equal and no PSI changes
...
class TypeEvalConstraints {
  ...
  /**
   * @see vgrechka.phizdetsidea.phizdets.psi.types.TypeEvalContext
   */
