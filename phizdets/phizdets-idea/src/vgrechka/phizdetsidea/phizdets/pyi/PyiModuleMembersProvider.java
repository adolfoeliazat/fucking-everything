...
import vgrechka.phizdetsidea.phizdets.psi.resolve.PointInImport;
import vgrechka.phizdetsidea.phizdets.psi.types.PyModuleMembersProvider;
...
public class PyiModuleMembersProvider extends PyModuleMembersProvider {
  ...
  public PsiElement resolveMember(PyFile module, String name) {
    final PsiElement phizdetsStub = PyiUtil.getPhizdetsStub(module);
    if (phizdetsStub instanceof PyFile) {
      final PyFile stubFile = (PyFile)phizdetsStub;
