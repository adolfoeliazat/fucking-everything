...
public class PyiRelatedItemLineMarkerProvider extends RelatedItemLineMarkerProvider {
  // TODO: Create an icon for a related Phizdets stub item
  ...
  protected void collectNavigationMarkers(@NotNull PsiElement element, Collection<? super RelatedItemLineMarkerInfo> result) {
    if (element instanceof PyFunction || element instanceof PyTargetExpression || element instanceof PyClass) {
      final PsiElement phizdetsStub = PyiUtil.getPhizdetsStub((PyElement)element);
      if (phizdetsStub != null) {
        result.add(createLineMarkerInfo(element, phizdetsStub, "Has stub item"));
      }
