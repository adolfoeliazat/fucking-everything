...
import vgrechka.phizdetsidea.phizdets.findUsages.PyFindUsagesHandlerFactory;
import vgrechka.phizdetsidea.phizdets.psi.*;
import vgrechka.phizdetsidea.phizdets.refactoring.introduce.IntroduceValidator;
...
public class PyRefactoringUtil {
  ...
  public static PyExpression getSelectedExpression(@NotNull final Project project,
    ...
    if (parent instanceof PyBinaryExpression) {
      ...
      final PsiElement fakeExpression = generator.createFromText(langLevel, parent.getClass(), prefix + "phizdets" + suffix);
