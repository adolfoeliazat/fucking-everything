...
import vgrechka.phizdetsidea.phizdets.refactoring.classes.membersManager.vp.BadDataException;
import vgrechka.phizdetsidea.phizdets.refactoring.classes.membersManager.vp.MembersBasedPresenterNoPreviewImpl;
...
class PyExtractSuperclassPresenterImpl extends MembersBasedPresenterNoPreviewImpl<PyExtractSuperclassView,
  ...
  private final NamesValidator myNamesValidator = LanguageNamesValidation.INSTANCE.forLanguage(PhizdetsLanguage.getInstance());
