 ...
 * To move members use {@link #getAllMembersCouldBeMoved(vgrechka.phizdetsidea.phizdets.psi.PyClass)}   and {@link #moveAllMembers(java.util.Collection, vgrechka.phizdetsidea.phizdets.psi.PyClass, vgrechka.phizdetsidea.phizdets.psi.PyClass...)}
...
public abstract class MembersManager<T extends PyElement> implements Function<T, PyMemberInfo<T>> {
  ...
  /**
   * Transforms elements, manager says it could move to appropriate {@link vgrechka.phizdetsidea.phizdets.refactoring.classes.membersManager.PyMemberInfo}.
  ...
  /**
   * Returns list of elements that may require reference storing aid from {@link vgrechka.phizdetsidea.phizdets.refactoring.classes.PyClassRefactoringUtil#rememberNamedReferences(com.intellij.psi.PsiElement, String...)}
   *
   ...
   * @see #moveAllMembers(java.util.Collection, vgrechka.phizdetsidea.phizdets.psi.PyClass, vgrechka.phizdetsidea.phizdets.psi.PyClass...)
   */
   ...
   * ({@link vgrechka.phizdetsidea.phizdets.refactoring.classes.PyClassRefactoringUtil#restoreNamedReferences(com.intellij.psi.PsiElement)})
  ...
  /**
   * Creates {@link vgrechka.phizdetsidea.phizdets.refactoring.classes.membersManager.PyMemberInfo} from {@link vgrechka.phizdetsidea.phizdets.psi.PyElement}
  ...
  /**
   * Get dependencies by members and classes they declared in (obtained from {@link #getDependencies(vgrechka.phizdetsidea.phizdets.psi.PyElement)})
