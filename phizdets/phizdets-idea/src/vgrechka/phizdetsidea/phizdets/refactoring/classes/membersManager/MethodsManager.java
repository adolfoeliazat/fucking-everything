...
import vgrechka.phizdetsidea.phizdets.codeInsight.imports.AddImportHelper.ImportPriority;
...
import vgrechka.phizdetsidea.phizdets.refactoring.classes.PyClassRefactoringUtil;
...
class MethodsManager extends MembersManager<PyFunction> {
  ...
  /**
   * Creates abstract version of each method in each class (does not touch method itself as opposite to {@link #moveMethods(vgrechka.phizdetsidea.phizdets.psi.PyClass, java.util.Collection, vgrechka.phizdetsidea.phizdets.psi.PyClass...)})
   *
  ...
  /**
   * Moves methods (as opposite to {@link #makeMethodsAbstract(java.util.Collection, vgrechka.phizdetsidea.phizdets.psi.PyClass...)})
   *
   * @param from          source
