 ...
 */
package vgrechka.phizdetsidea.phizdets.refactoring.invertBoolean;
  ...
  public void collectRefElements(PsiElement psiElement,
    ...
    for (PsiReference ref : refs) {
      ...
      if (elementToInvert != null) {
        ...
        ContainerUtil.addIfNotNull(elementsToInvert, getForeignElementToInvert(psiElement, refElement, PhizdetsLanguage.getInstance()));
      }
    }
  }
