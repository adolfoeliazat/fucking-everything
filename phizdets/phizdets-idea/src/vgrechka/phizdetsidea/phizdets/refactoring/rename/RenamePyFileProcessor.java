...
import vgrechka.phizdetsidea.phizdets.psi.PyImportStatementBase;
        ...
        if (importStatement != null) {
          result.add(new UnresolvableCollisionUsageInfo(importStatement, element) {
            ...
            public String getDescription() {
              return "The name '" + newFileName + "' is not a valid Phizdets identifier. Cannot update import statement in '" +
