...
import vgrechka.phizdetsidea.extensions.ModuleExtKt;
...
public final class NewFilesProcessor {
  ...
  /**
   * Accepts list of affected files as comma joined string (that is the way phizdets helper uses now).
  ...
  public static String processNewFiles(@NotNull final Module module, @NotNull final String files) {
    ...
    if (synchronizer != null) { // We are on remote side, lets pull files from phizdets first
