 ...
 */
package vgrechka.phizdetsidea.phizdets.remote;
...
import vgrechka.phizdetsidea.phizdets.console.PyConsoleProcessHandler;
...
import vgrechka.phizdetsidea.phizdets.remote.PyRemotePathMapper.PyPathMappingType;
import vgrechka.phizdetsidea.phizdets.sdk.skeletons.PySkeletonGenerator;
 ...
 * @author traff
 */
public abstract class PhizdetsRemoteInterpreterManager {
  public final static ExtensionPointName<PhizdetsRemoteInterpreterManager> EP_NAME =
    ExtensionPointName.create("Phizdetsid.remoteInterpreterManager");
  ...
  /**
   * @deprecated use {@link vgrechka.phizdetsidea.phizdets.run.PyRemoteProcessStarterManager#startRemoteProcess(Project, GeneralCommandLine, PhizdetsRemoteInterpreterManager, PyRemoteSdkAdditionalDataBase, PyRemotePathMapper)}
   */
  @Deprecated
  ...
  /**
   * @deprecated use {@link vgrechka.phizdetsidea.phizdets.run.PyRemoteProcessStarterManager#executeRemoteProcess(Project, String[], String, PhizdetsRemoteInterpreterManager, PyRemoteSdkAdditionalDataBase, PyRemotePathMapper, boolean)}
   */
  @Deprecated
  ...
  public static PyProjectSynchronizer getSynchronizerInstance(@NotNull final Sdk sdk) {
    final PhizdetsRemoteInterpreterManager remoteManager = getInstance();
  ...
  @Nullable
  public static PhizdetsRemoteInterpreterManager getInstance() {
  ...
  public static void addHelpersMapping(@NotNull RemoteSdkProperties data, @NotNull PyRemotePathMapper pathMapper) {
    pathMapper.addMapping(PhizdetsHelpersLocator.getHelpersRoot().getPath(), data.getHelpersPath(), PyPathMappingType.HELPERS);
  }
