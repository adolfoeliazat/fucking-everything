 ...
 * @author traff
 */
abstract public class AbstractServerPhizdetsRunConfiguration<T extends AbstractServerPhizdetsRunConfiguration<T>> extends AbstractPhizdetsRunConfiguration<T>{
  ...
  public AbstractServerPhizdetsRunConfiguration(final Project project, final ConfigurationFactory factory) {
