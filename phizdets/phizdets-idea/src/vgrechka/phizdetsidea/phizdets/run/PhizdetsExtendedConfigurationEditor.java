 ...
 */
public class PhizdetsExtendedConfigurationEditor<T extends AbstractPhizdetsRunConfiguration<T>> extends SettingsEditor<T> {
  @NotNull private final SettingsEditor<T> myMainSettingsEditor;

  private PyRunConfigurationEditorExtension myCurrentEditor;
  private SettingsEditor<AbstractPhizdetsRunConfiguration> myCurrentSettingsEditor;
  private JComponent myCurrentSettingsEditorComponent;

  private JPanel mySettingsPlaceholder;

  public PhizdetsExtendedConfigurationEditor(@NotNull SettingsEditor<T> editor) {
  ...
  @NotNull
  public static <T extends AbstractPhizdetsRunConfiguration<T>> PhizdetsExtendedConfigurationEditor<T> create(@NotNull SettingsEditor<T> editor) {
    return new PhizdetsExtendedConfigurationEditor<>(editor);
  }
}
