 ...
 * @author yole
 */
public class PhizdetsRunConfiguration extends AbstractPhizdetsRunConfiguration
  implements AbstractPhizdetsRunConfigurationParams, PhizdetsRunConfigurationParams, RefactoringListenerProvider {
  ...
  protected PhizdetsRunConfiguration(Project project, ConfigurationFactory configurationFactory) {
  ...
  protected SettingsEditor<? extends RunConfiguration> createConfigurationEditor() {
    return new PhizdetsRunConfigurationEditor(this);
  }

  public RunProfileState getState(@NotNull final Executor executor, @NotNull final ExecutionEnvironment env) throws ExecutionException {
    return new PhizdetsScriptCommandLineState(this, env);
  }
  ...
  public static void copyParams(PhizdetsRunConfigurationParams source, PhizdetsRunConfigurationParams target) {
