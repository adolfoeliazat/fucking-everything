 ...
 * @author yole
 */
public class PhizdetsRunConfigurationForm implements PhizdetsRunConfigurationParams, PanelWithAnchor {
  ...
  public PhizdetsRunConfigurationForm(PhizdetsRunConfiguration configuration) {
