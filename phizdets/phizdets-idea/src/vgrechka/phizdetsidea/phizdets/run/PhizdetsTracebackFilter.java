...
import vgrechka.phizdetsidea.phizdets.traceBackParsers.LinkInTrace;
import vgrechka.phizdetsidea.phizdets.traceBackParsers.TraceBackParser;
 ...
 * @author yole
 */
public class PhizdetsTracebackFilter implements Filter {
  private final Project myProject;
  private final String myWorkingDirectory;

  public PhizdetsTracebackFilter(final Project project) {
    myProject = project;
    myWorkingDirectory = null;
  }

  public PhizdetsTracebackFilter(final Project project, @Nullable final String workingDirectory) {
    myProject = project;
