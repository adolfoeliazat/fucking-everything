...
public abstract class PyRunConfigurationFactory {
  ...
  /**
   * Creates a run configuration to run a specified Phizdets script.
   *
   ...
   */
  public abstract PhizdetsRunConfigurationParams createPhizdetsScriptRunConfiguration(Module module, String scriptName, boolean singleton);
