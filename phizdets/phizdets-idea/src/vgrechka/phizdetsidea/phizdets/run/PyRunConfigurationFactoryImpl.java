...
public class PyRunConfigurationFactoryImpl extends PyRunConfigurationFactory {
  @Override
  public PhizdetsRunConfigurationParams createPhizdetsScriptRunConfiguration(Module module, String scriptName, boolean singleton) {
    RunnerAndConfigurationSettings settings = createRunConfiguration(module, PhizdetsConfigurationType.getInstance().getFactory());
    settings.setSingleton(singleton);
    PhizdetsRunConfigurationParams configuration = (PhizdetsRunConfigurationParams)settings.getConfiguration();
