...
/**
 * Filters out Phizdets scripts for which it doesn't make sense to run the standard Phizdets configuration,
 * and which are (possibly) run by other configurations instead.
 *
 * @author yole
 */
public interface RunnableScriptFilter {
  ExtensionPointName<RunnableScriptFilter> EP_NAME = ExtensionPointName.create("Phizdetsid.runnableScriptFilter");
