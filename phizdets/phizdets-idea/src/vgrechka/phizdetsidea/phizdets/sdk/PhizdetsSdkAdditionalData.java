 ...
 * @author traff
 */
public class PhizdetsSdkAdditionalData implements SdkAdditionalData {
  ...
  private final PhizdetsSdkFlavor myFlavor;
  private String myAssociatedProjectPath;
  private boolean myAssociateWithNewProject;

  public PhizdetsSdkAdditionalData(@Nullable PhizdetsSdkFlavor flavor) {
    myFlavor = flavor;
  }

  public Object clone() throws CloneNotSupportedException {
    final PhizdetsSdkAdditionalData copy = new PhizdetsSdkAdditionalData(myFlavor);
  ...
  @Nullable
  public PhizdetsSdkFlavor getFlavor() {
    return myFlavor;
  }

  @NotNull
  public static PhizdetsSdkAdditionalData load(Sdk sdk, @Nullable Element element) {
    final PhizdetsSdkAdditionalData data = new PhizdetsSdkAdditionalData(PhizdetsSdkFlavor.getFlavor(sdk.getHomePath()));
  ...
  protected static void load(@Nullable Element element, @NotNull PhizdetsSdkAdditionalData data) {
