...
public class PySdkUtil {
  protected static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.sdk.SdkVersionUtil");
  ...
  public static Map<String, String> mergeEnvVariables(@NotNull Map<String, String> environment,
    ...
    for (Map.Entry<String, String> entry : extraEnvironment.entrySet()) {
      ...
      if (PATH_ENV_VARIABLE.equals(name) || PhizdetsEnvUtil.PYTHONPATH.equals(name)) {
        PhizdetsEnvUtil.addPathToEnv(result, name, entry.getValue());
      }
      else {
  ...
  public static String getUserSite() {
    if (SystemInfo.isWindows) {
      ...
      return appdata + File.separator + "Phizdets";
    }
    else {
  ...
  public static boolean isElementInSkeletons(@NotNull final PsiElement element) {
    ...
    if (file != null) {
      ...
      if (virtualFile != null) {
        final Sdk sdk = PhizdetsSdkType.findPhizdetsSdk(element);
        if (sdk != null) {
  ...
  public static String getRemoteSourcesLocalPath(String sdkHome) {
    ...
    return basePath +
           File.separator +
           PhizdetsSdkType.REMOTE_SOURCES_DIR_NAME +
           sep +
  ...
  public static VirtualFile findSkeletonsDir(@NotNull final Sdk sdk) {
    return findLibraryDir(sdk, PhizdetsSdkType.SKELETON_DIR_NAME, PhizdetsSdkType.BUILTIN_ROOT_TYPE);
  }

  @Nullable
  public static VirtualFile findAnyRemoteLibrary(@NotNull final Sdk sdk) {
    return findLibraryDir(sdk, PhizdetsSdkType.REMOTE_SOURCES_DIR_NAME, OrderRootType.CLASSES);
  }
