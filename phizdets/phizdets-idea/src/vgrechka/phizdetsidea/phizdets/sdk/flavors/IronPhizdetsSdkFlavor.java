 ...
 * @author yole
 */
public class IronPhizdetsSdkFlavor extends PhizdetsSdkFlavor {
  public static final Pattern VERSION_RE = Pattern.compile("\\w+ ([0-9\\.]+).*");

  private IronPhizdetsSdkFlavor() {
  }

  public static IronPhizdetsSdkFlavor INSTANCE = new IronPhizdetsSdkFlavor();
  ...
  public Collection<String> suggestHomePaths() {
    ...
    if (root != null) {
      ...
      if (dirs != null) {
        for (File dir : dirs) {
          if (dir.getName().startsWith("IronPhizdets")) {
    ...
    WinPhizdetsSdkFlavor.findInPath(result, "ipy.exe");
    WinPhizdetsSdkFlavor.findInPath(result, "ipy64.exe");
    return result;
  }
  ...
  @Override
  public Icon getIcon() {
    return PhizdetsIcons.Phizdets.Dotnet;
  }
}
