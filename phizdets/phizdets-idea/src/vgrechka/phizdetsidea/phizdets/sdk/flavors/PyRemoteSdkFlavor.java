 ...
 * @author traff
 */
public class PyRemoteSdkFlavor extends CPhizdetsSdkFlavor {
  private PyRemoteSdkFlavor() {
  }

  private final static String[] NAMES = new String[]{"phizdets", "jython", "pypy", "python.exe", "jython.bat", "pypy.exe"};
  ...
  @Override
  public Icon getIcon() {
    return PhizdetsIcons.Phizdets.RemoteInterpreter;
  }
}
