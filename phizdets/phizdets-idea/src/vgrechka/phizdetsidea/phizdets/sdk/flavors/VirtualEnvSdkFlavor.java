 ...
 * User : catherine
 */
public class VirtualEnvSdkFlavor extends CPhizdetsSdkFlavor {
  ...
  public boolean isValidSdkPath(@NotNull File file) {
    ...
    return PhizdetsSdkType.getVirtualEnvRoot(file.getPath()) != null;
  }

  @Override
  public Icon getIcon() {
    return PhizdetsIcons.Phizdets.Virtualenv;
  }
}
