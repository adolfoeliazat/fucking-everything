...
public class PySkeletonGenerator {
  ...
  private static final Map<Class<? extends PhizdetsSdkFlavor>, String> ENV_PATH_PARAM =
    new HashMap<>();

  static {
    ENV_PATH_PARAM.put(IronPhizdetsSdkFlavor.class, "IRONPYTHONPATH"); // TODO: Make strategy and move to PhizdetsSdkFlavor?
  }
  ...
  public PySkeletonGenerator(String skeletonPath, @NotNull final Sdk pySdk, @Nullable final String currentFolder) {
    ...
    final PhizdetsSdkFlavor flavor = PhizdetsSdkFlavor.getFlavor(pySdk);
  ...
  public ProcessOutput runSkeletonGeneration(String modname,
    ...
    commandLine.add(PhizdetsHelpersLocator.getHelperPath(GENERATOR3));
    commandLine.add("-d");
    ...
    final Map<String, String> extraEnv = PhizdetsSdkType.getVirtualEnvExtraEnv(binaryPath);
  ...
  protected ProcessOutput getProcessOutput(String homePath, String[] commandLine, Map<String, String> extraEnv,
    ...
    PhizdetsEnvUtil.setPhizdetsDontWriteBytecode(env);
  ...
  public void generateBuiltinSkeletons(@NotNull Sdk sdk) throws InvalidSdkException {
    ...
    final ProcessOutput runResult = getProcessOutput(
      ...
      new String[]{
        binaryPath,
        PhizdetsHelpersLocator.getHelperPath(GENERATOR3),
        "-d", mySkeletonsPath, // output dir
        "-b", // for builtins
      },
      PhizdetsSdkType.getVirtualEnvExtraEnv(binaryPath), MINUTE * 5
    );
  ...
  public ListBinariesResult listBinaries(@NotNull Sdk sdk, @NotNull String extraSysPath) throws InvalidSdkException {
    ...
    List<String> cmd = new ArrayList<>(Arrays.asList(homePath, PhizdetsHelpersLocator.getHelperPath(GENERATOR3), "-v", "-L"));
    if (!StringUtil.isEmpty(extraSysPath)) {
      cmd.add("-s");
    ...
    final ProcessOutput process = getProcessOutput(parentDir,
                                                   ...
                                                   PhizdetsSdkType.getVirtualEnvExtraEnv(homePath),
