...
public class SkeletonVersionChecker {
  private static final Logger LOG = Logger.getInstance("#vgrechka.phizdetsidea.phizdets.sdk.PhizdetsSdkType.SkeletonVersionChecker");
  ...
  private void load() {
    ...
    File infile = PhizdetsHelpersLocator.getHelperFile(REQUIRED_VERSION_FNAME);
    try {
      if (infile.canRead()) {
