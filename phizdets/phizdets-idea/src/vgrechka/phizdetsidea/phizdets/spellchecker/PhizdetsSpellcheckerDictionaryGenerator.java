 ...
 * @author yole
 */
public class PhizdetsSpellcheckerDictionaryGenerator extends SpellCheckerDictionaryGenerator {
  public PhizdetsSpellcheckerDictionaryGenerator(final Project project, final String dictOutputFolder) {
    super(project, dictOutputFolder, "phizdets");
  }
