 ...
 * @author yole
 */
public class PhizdetsSpellcheckerGenerateDictionariesAction extends AnAction {
  @Override
  public void actionPerformed(AnActionEvent e) {
    ...
    final PhizdetsSpellcheckerDictionaryGenerator generator = new PhizdetsSpellcheckerDictionaryGenerator(module.getProject(),
    ...
    for (VirtualFile root : roots) {
      if (root.getName().equals("Lib")) {
        generator.addFolder("phizdets", root);
