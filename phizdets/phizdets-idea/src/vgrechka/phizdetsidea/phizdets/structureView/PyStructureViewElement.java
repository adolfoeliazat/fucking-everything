 ...
 */
package vgrechka.phizdetsidea.phizdets.structureView;
      ...
      public Icon getIcon(boolean open) {
        ...
        if (myVisibility == Visibility.NORMAL) {
          ...
          if (myVisibility == Visibility.PRIVATE || myVisibility == Visibility.PROTECTED) {
            overlay = PhizdetsIcons.Phizdets.Nodes.Lock;
          }
          else if (myVisibility == Visibility.PREDEFINED) {
            overlay = PhizdetsIcons.Phizdets.Nodes.Cyan_dot;
          }
          else if (myVisibility == Visibility.INVISIBLE) {
            overlay = PhizdetsIcons.Phizdets.Nodes.Red_inv_triangle;
          }
          if (overlay != null) {
