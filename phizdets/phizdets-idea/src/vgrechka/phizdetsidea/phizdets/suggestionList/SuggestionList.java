 ...
 */
package vgrechka.phizdetsidea.phizdets.suggestionList;
 ...
 * Each suggestion may also be marked as strong (see {@link vgrechka.phizdetsidea.phizdets.suggestionList.Suggestion}
 *
...
public class SuggestionList {
   ...
   * @see vgrechka.phizdetsidea.phizdets.suggestionList.SuggestionsBuilder
   */
   ...
   *                        {@link vgrechka.phizdetsidea.phizdets.suggestionList.SuggestionsBuilder} is easier to use
   * @param displayPoint    point on screen to display suggestions
   * @param elementToSelect element in list to be selected (if any)
   */
