...
/**
 * Parent of all phizdets test old-style test runners.
 * For new style see {@link vgrechka.phizdetsidea.phizdets.testing.universalTests}
 * User: catherine
 */
public abstract class AbstractPhizdetsLegacyTestRunConfiguration<T extends AbstractPhizdetsTestRunConfiguration<T>>
  extends AbstractPhizdetsTestRunConfiguration<T>
  implements AbstractPhizdetsRunConfigurationParams,
             AbstractPhizdetsTestRunConfigurationParams,
  ...
  protected AbstractPhizdetsLegacyTestRunConfiguration(Project project, ConfigurationFactory configurationFactory) {
  ...
  public AbstractPhizdetsRunConfigurationParams getBaseParams() {
    return this;
  }
  ...
  public boolean compareSettings(AbstractPhizdetsLegacyTestRunConfiguration cfg) {
  ...
  public static void copyParams(AbstractPhizdetsTestRunConfigurationParams source, AbstractPhizdetsTestRunConfigurationParams target) {
    AbstractPhizdetsRunConfiguration.copyParams(source.getBaseParams(), target.getBaseParams());
