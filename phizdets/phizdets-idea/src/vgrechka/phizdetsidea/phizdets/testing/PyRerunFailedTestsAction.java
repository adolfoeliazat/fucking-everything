...
public class PyRerunFailedTestsAction extends AbstractRerunFailedTestsAction {
  ...
  protected MyRunProfile getRunProfile(@NotNull ExecutionEnvironment environment) {
    ...
    return new MyTestRunProfile((AbstractPhizdetsRunConfiguration)model.getProperties().getConfiguration());
  }
  ...
  private class MyTestRunProfile extends MyRunProfile {
    ...
    public Module[] getModules() {
      return ((AbstractPhizdetsRunConfiguration)getPeer()).getModules();
    }

    @Nullable
    @Override
    public RunProfileState getState(@NotNull Executor executor, @NotNull ExecutionEnvironment env) throws ExecutionException {
      final AbstractPhizdetsTestRunConfiguration<?> configuration = ((AbstractPhizdetsTestRunConfiguration)getPeer());
      ...
      return new FailedPhizdetsTestCommandLineStateBase(configuration, env,
                                                      (PhizdetsTestCommandLineStateBase)configuration.getState(executor, env));
    }
  }

  private class FailedPhizdetsTestCommandLineStateBase extends PhizdetsTestCommandLineStateBase<AbstractPhizdetsTestRunConfiguration<?>> {
    private final PhizdetsTestCommandLineStateBase<?> myState;
    private final Project myProject;

    public FailedPhizdetsTestCommandLineStateBase(AbstractPhizdetsTestRunConfiguration<?> configuration,
                                                ExecutionEnvironment env,
                                                PhizdetsTestCommandLineStateBase<?> state) {
    ...
    protected List<String> getTestSpecs() {
      ...
      final AbstractPhizdetsTestRunConfiguration<?> configuration = getConfiguration();
      ...
      if (result.isEmpty()) {
        ...
        Logger.getInstance(FailedPhizdetsTestCommandLineStateBase.class).warn(
