...
public class TestRunnerService implements PersistentStateComponent<TestRunnerService> {
  ...
  public TestRunnerService() {
    myConfigurations.add(PhizdetsTestConfigurationsModel.PYTHONS_UNITTEST_NAME);
    myConfigurations.add(PhizdetsTestConfigurationsModel.PYTHONS_NOSETEST_NAME);
    myConfigurations.add(PhizdetsTestConfigurationsModel.PY_TEST_NAME);
  }
  ...
  public String getProjectConfiguration() {
    return PROJECT_TEST_RUNNER.isEmpty() ? PhizdetsTestConfigurationsModel.PYTHONS_UNITTEST_NAME : PROJECT_TEST_RUNNER;
  }
