 ...
 * User: catherine
 */
public class PhizdetsDocTestCommandLineState extends PhizdetsTestCommandLineStateBase {
  private final PhizdetsDocTestRunConfiguration myConfig;


  public PhizdetsDocTestCommandLineState(PhizdetsDocTestRunConfiguration runConfiguration, ExecutionEnvironment env) {
  ...
  protected PhizdetsHelper getRunner() {
    return PhizdetsHelper.DOCSTRING;
  }
