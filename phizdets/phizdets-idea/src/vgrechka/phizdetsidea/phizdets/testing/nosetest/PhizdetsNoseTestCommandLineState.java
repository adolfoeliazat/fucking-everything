 ...
 * User: catherine
 */
public class PhizdetsNoseTestCommandLineState extends PhizdetsTestCommandLineStateBase {
  private final PhizdetsNoseTestRunConfiguration myConfig;

  public PhizdetsNoseTestCommandLineState(PhizdetsNoseTestRunConfiguration runConfiguration, ExecutionEnvironment env) {
  ...
  protected PhizdetsHelper getRunner() {
    return PhizdetsHelper.NOSE_OLD;
  }
  ...
  protected SMTestLocator getTestLocator() {
    return PhizdetsNoseTestUrlProvider.INSTANCE;
  }
