 ...
 * User: catherine
 */
public class PhizdetsNoseTestRunConfigurationForm implements PhizdetsNoseTestRunConfigurationParams {
  private JPanel myRootPanel;

  private final PhizdetsTestRunConfigurationForm myTestRunConfigurationForm;

  public PhizdetsNoseTestRunConfigurationForm(final Project project, final PhizdetsNoseTestRunConfiguration configuration) {
