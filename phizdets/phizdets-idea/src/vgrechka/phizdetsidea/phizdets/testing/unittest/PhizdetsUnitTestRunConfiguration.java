 ...
 */
public class PhizdetsUnitTestRunConfiguration extends
                                            AbstractPhizdetsLegacyTestRunConfiguration<PhizdetsUnitTestRunConfiguration>
                                              implements PhizdetsUnitTestRunConfigurationParams {
  ...
  public PhizdetsUnitTestRunConfiguration(Project project,
                                        ConfigurationFactory configurationFactory) {
    super(project, configurationFactory);
  }

  @Override
  protected SettingsEditor<PhizdetsUnitTestRunConfiguration> createConfigurationEditor() {
    return new PhizdetsUnitTestRunConfigurationEditor(getProject(), this);
  }

  @Override
  public RunProfileState getState(@NotNull final Executor executor, @NotNull final ExecutionEnvironment env) throws ExecutionException {
    return new PhizdetsUnitTestCommandLineState(this, env);
  }
  ...
  public static void copyParams(PhizdetsUnitTestRunConfigurationParams source, PhizdetsUnitTestRunConfigurationParams target) {
