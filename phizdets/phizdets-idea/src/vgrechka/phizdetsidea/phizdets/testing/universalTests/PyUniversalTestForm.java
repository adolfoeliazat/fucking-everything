...
import vgrechka.phizdetsidea.reflection.ReflectionUtilsKt;
import vgrechka.phizdetsidea.reflection.SimplePropertiesProvider;
...
public final class PyUniversalTestForm implements SimplePropertiesProvider {
  ...
  public static PyUniversalTestForm create(@NotNull
    ...
    final FileChooserDescriptor descriptor = FileChooserDescriptorFactory.createSingleFileOrFolderDescriptor(PhizdetsFileType.INSTANCE);
