 ...
 * Note that by using {@link vgrechka.phizdetsidea.phizdets.inspections.PhizdetsVisitorFilter} you can disable PEP 8 inspection for concrete files
 * altogether.
 *
 * @author Mikhail Golubev
 * @see Pep8ExternalAnnotator
 * @see vgrechka.phizdetsidea.phizdets.inspections.PhizdetsVisitorFilter
 */
public interface Pep8ProblemSuppressor {
  ExtensionPointName<Pep8ProblemSuppressor> EP_NAME = ExtensionPointName.create("Phizdetsid.pep8ProblemSuppressor");
