...
//        fun getCode(): String = getCode(TextOutputImpl(), sourceMapBuilder = null)
        ...
        fun getOutputFiles(outputFile: File, outputPrefixFile: File?, outputPostfixFile: File?): OutputFileCollection {
            ...
            val codeAndDebugShit = getCodeAndDebugShit(output, taggedGenOutput, sourceMapBuilder)
            ...
            val outputFiles = arrayListOf<OutputFile>(jsFile, taggedGenFile)
            ...
            if (config.configuration.getBoolean(JSConfigurationKeys.META_INFO)) {
                ...
                KotlinJavascriptSerializationUtil.toContentMap(bindingContext, moduleDescriptor).forEach {
                    ...
                    outputFiles.add(SimpleOutputBinaryFile(emptyList(), config.moduleId + '/' + it.key, it.value))
                }
            }
        ...
        private fun getCodeAndDebugShit(output: TextOutput, taggedGenOutput: TextOutput, sourceMapBuilder: SourceMapBuilder?): CodeAndDebugShit {
            ...
            return CodeAndDebugShit(
                ...
                taggedGen = taggedGenOutput.toString()
            )
        }
