...
//    @Override
//    public void visitPHPInvocation(@NotNull PHPInvocation x) {answer = 16;}

    @Override
    public void visitPHPMethodCall(@NotNull PHPMethodCall x) {answer = 16;}

    @Override
    public void visitPHPStaticMethodCall(@NotNull PHPStaticMethodCall x) {answer = 16;}

//    @Override
//    public void visitPHPFieldRef(@NotNull PHPFieldRef x) {answer = 16;}
...
//    @Override
//    public void visitPHPVarRef(@NotNull PHPVarRef varRef) {
...
//    }
    ...
    @Override
    public void visitPHPGlobalVarRef(@NotNull PHPGlobalVarRef varRef) {
        final boolean isLeaf = true;
        if (isLeaf) {
            answer = 17; // primary
        }
    ...
    @Override
    public void visitPHPPlainCodeExpression(@NotNull PHPPlainCodeExpression x) {
        answer = 17;
    }
