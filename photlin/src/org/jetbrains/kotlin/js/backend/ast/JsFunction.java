...
public final class JsFunction extends JsLiteral implements HasName {
    ...
    private JsName name;
    public boolean shouldPrintName;
    public List<JsNameRef> useNames = Collections.emptyList();
    ...
    public JsFunction deepCopy() {
        ...
        functionCopy.shouldPrintName = shouldPrintName;
        functionCopy.useNames = AstUtil.deepCopy(useNames);
