...
public final class StaticContext {
    ...
    public static StaticContext current;
    ...
    @NotNull
    public final JsScope rootScope;
    ...
    private StaticContext(
        ...
        if (current != null) wtf("f0bf6e94-a819-491d-8ae1-cfa981635838");
        current = this;
    ...
    public JsExpression getQualifiedReference(@NotNull DeclarationDescriptor descriptor) {
        return getQualifiedExpression(descriptor);
//        return (JsNameRef) getQualifiedExpression(descriptor);
    ...
    private JsExpression buildQualifiedExpression(@NotNull DeclarationDescriptor descriptor) {
        ...
        // @fucking
        if (descriptor instanceof VariableDescriptor && partNames.size() == 1) {
            ...
            if (inRootPackage) {
                return new PHPGlobalVarRef(partNames.get(0));
            } else {
                return new JsNameRef(partNames.get(0)).setKind(PHPNameRefKind.VAR);
            }
        }
        ...
        if (expression instanceof JsNameRef) {
            JsNameRef expression_nameRef = (JsNameRef) expression;
            JsExpression qualifier1 = expression_nameRef.getQualifier();
            if (qualifier1 instanceof JsNameRef) {
                JsNameRef qualifier1_nameRef = (JsNameRef) qualifier1;
                if ("kotlin".equals(qualifier1_nameRef.getIdent())) {
                    JsExpression qualifier2 = qualifier1_nameRef.getQualifier();
                    if (qualifier2 instanceof JsNameRef) {
                        JsNameRef qualifier2_nameRef = (JsNameRef) qualifier2;
                        if ("Kotlin".equals(qualifier2_nameRef.getIdent())) {
                            expression_nameRef.setQualifier(null);
                            expression_nameRef.setName(rootScope.declareName("kotlin__" + expression_nameRef.getIdent()));
                        }
                    }
                }
            }
...
//        JsExpression qualifiedReference = getQualifiedReference(descriptor);
//        if (qualifiedReference instanceof JsNameRef) {
//            String ident = ((JsNameRef) qualifiedReference).getIdent();
//            if ("Object".equals(ident)) {
//                return;
//            }
//        }
//
//        imf("6c93d938-f71d-43b5-aed4-ac4f107d2e94");
        ...
        public ScopeGenerator() {
            ...
            Rule<JsScope> createFunctionObjectsForCallableDescriptors = new Rule<JsScope>() {
                ...
                public JsScope apply(@NotNull DeclarationDescriptor descriptor) {
                    ...
                    ShebangKt.setCallableDescriptor(correspondingFunction, (CallableDescriptor) descriptor);
                    ShebangKt.setDeclarationDescriptor(correspondingFunction, descriptor);
                    correspondingFunction.setName(getNameForDescriptor(descriptor));
                    // correspondingFunction.setName(phpName(descriptor.getName().asString()));
    ...
    private void addClassPrototypes(@NotNull ClassDescriptor cls, @NotNull Set<ClassDescriptor> visited) {
        ...
        if (superclass != null) {
            ...
            ShebangKt.setPhpSuperPrototypeNameRef(cls, (JsNameRef) superPrototype);
