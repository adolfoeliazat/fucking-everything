...
class DefaultPropertyTranslator(
    ...
    init {
//        if (delegateReference.toString().contains("myFuckingDir")) {
//            "break on me"
//        }
    }
...
fun TranslationContext.translateDelegateOrInitializerExpression(expression: KtProperty): JsExpression? {
    ...
    return if (provideDelegateCall != null) {
        val innerContext = this.contextWithPropertyMetadataCreationIntrinsified(provideDelegateCall, propertyDescriptor, phpThisRef())
