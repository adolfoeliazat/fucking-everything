...
public final class InitializerVisitor extends TranslatorVisitor<Void> {
    ...
    public final Void visitProperty(@NotNull KtProperty property, @NotNull TranslationContext context) {
        ...
        if (initializer != null) {
            ...
            assert value != null;
            statement = generateInitializerForDelegate(descriptor, value, context);
        }
            ...
            statement = JsAstUtils.assignment(new JsNameRef(propertyName, phpThisRef()), defaultValue).makeStmt();
        }
