...
public final class TopLevelFIF extends CompositeFIF {
    ...
    @NotNull
    public static final KotlinFunctionIntrinsic TO_STRING_BEING_DEBUGGED2 = new KotlinFunctionIntrinsic("toString");
    {
        TO_STRING_BEING_DEBUGGED2.beingDebugged2 = true;
    }
    ...
    private TopLevelFIF() {
        ...
        PatternBuilder.DescriptorPredicateImpl toStringPredicate = pattern("kotlin", "toString").isExtensionOf(FQ_NAMES.any.asString());
        toStringPredicate.beingDebugged1 = true;
        add(toStringPredicate, TO_STRING);

        add(pattern("kotlin", "Any", "toString").isExtensionOf(FQ_NAMES.any.asString()), TO_STRING_BEING_DEBUGGED2);
