...
import photlinc.PHPPlainCodeExpression;
...
public final class TranslationUtils {
    ...
    @NotNull
    public static JsExpression backingFieldReference(@NotNull TranslationContext context, @NotNull PropertyDescriptor descriptor) {
        ...
        if (receiver != null) {
            return new JsNameRef(backingFieldName, receiver).setKind(PHPNameRefKind.FIELD);
        } else {
            return new JsNameRef(backingFieldName);
        }
    }
    ...
    public static JsExpression assignmentToBackingField(@NotNull TranslationContext context,
        ...
        JsExpression backingFieldReference = backingFieldReference(context, descriptor);
