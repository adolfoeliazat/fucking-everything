 ...
 */
public final class SourceMapConsumerV3Hack implements SourceMapConsumer,
    ...
    public boolean allowInexactMatches;
    ...
    public OriginalMapping getMappingForLine(int lineNumber, int column) {
        ...
        if (allowInexactMatches) {
            ...
            return getOriginalMappingForEntry(entries.get(0));
        }
    }
