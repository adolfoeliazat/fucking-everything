...
private val sqliteURLToFuckAroundWith = "jdbc:sqlite:e:/febig/db/shebang.db"

object Spike_SQLite_1 {
    @JvmStatic
    fun main(args: Array<String>) {
        val con = DriverManager.getConnection(sqliteURLToFuckAroundWith)
...
object Spike_SQLite_DataSource {
    ...
    fun main(args: Array<String>) {
        ...
        ds.url = sqliteURLToFuckAroundWith
...
object Spike_SaveShitToSQLiteAndLoadBackViaHibernate_1 {
    @JvmStatic
    fun main(args: Array<String>) {
