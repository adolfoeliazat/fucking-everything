 ...
 * 
 */
public class IntoSQLiteDataSource implements DataSource
{
    private SQLiteConfig          config;
    private transient PrintWriter logger;
    private int                   loginTimeout = 1;

    private String                url          = IntoSQLiteJDBCDriver.PREFIX; // use memory database in default
    private String                databaseName = ""; // the name of the current database

    /**
     * Default constructor.
     */
    public IntoSQLiteDataSource() {
     ...
     */
    public IntoSQLiteDataSource(SQLiteConfig config) {
        this.config = config;
    }
     ...
     * @see IntoSQLiteDataSource#setDatabaseName(String)
     */
    ...
    public Connection getConnection(String username, String password) throws SQLException {
        ...
        if (password != null)
            p.put("pass", password);
        return IntoSQLiteJDBCDriver.createConnection(url, p);
    }
