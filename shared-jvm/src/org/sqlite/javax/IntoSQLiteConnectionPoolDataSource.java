...
import org.sqlite.IntoSQLiteDataSource;
...
public class IntoSQLiteConnectionPoolDataSource extends IntoSQLiteDataSource implements javax.sql.ConnectionPoolDataSource {

    /**
     * Default constructor.
     */
    public IntoSQLiteConnectionPoolDataSource() {
        super();
    }
     ...
     */
    public IntoSQLiteConnectionPoolDataSource(SQLiteConfig config) {
        super(config);
    }
