        ...
        CommonDBEntitySpew(
            ...
            pedro = object : CommonDBEntitySpew.Pedro {
                override fun spitRepo(ctx: CommonDBEntitySpew.spitShitForEntity, ctx2: CommonDBEntitySpew) {
                    val out = ctx.out; val en = ctx.en; val end = ctx.end; val entity = ctx.entity
                ...
                private fun spitGeneratedRepo(ctx: CommonDBEntitySpew.spitShitForEntity) {
                    val out = ctx.out; val en = ctx.en; val entity = ctx.entity
                ...
                override fun spitEntityClass(ctx: CommonDBEntitySpew.spitShitForEntity, ctx2: CommonDBEntitySpew) {
                    val out = ctx.out; val entity = ctx.entity; val en = ctx.en; val end = ctx.end
                    ...
                    for ((index, field) in entity.fields.withIndex()) {
                        exhaustive=when (field.kind) {
                            ...
                            is FieldKind.Many -> {
                                ...
                                val entity = ctx2.entities.find {it.name == field.type} ?: wtf("68c50078-c088-476b-9a52-7c1657412fc3")
...
//                out.append(",")
                ...
                override fun spitImports(ctx: CommonDBEntitySpew) {
                    ctx.out.appendln("import vgrechka.db.*")
                }
